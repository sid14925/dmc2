...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(e,t,n){let r=new Float32Array(La),i=new U(0,1,0);return new vi({name:`SphericalGaussianBlur`,defines:{n:La,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new vi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new vi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
	...
	`}var to=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ti([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
...
}`,Ac=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ii(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new vi({vertexShader:Oc,fragmentShader:kc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Y(new si(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},jc=class extends tt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new Ac,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new H,O=null,k=new Zi;k.viewport=new Dt;let te=new Zi;te.viewport=new Dt;let ne=[k,te],A=new sa,j=null,M=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new cn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new cn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new cn,C[e]=t),t.getHandSpace()};function N(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function re(){r.removeEventListener(`select`,N),r.removeEventListener(`selectstart`,N),r.removeEventListener(`selectend`,N),r.removeEventListener(`squeeze`,N),r.removeEventListener(`squeezestart`,N),r.removeEventListener(`squeezeend`,N),r.removeEventListener(`end`,re),r.removeEventListener(`inputsourceschange`,ie);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}j=null,M=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,de.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,N),r.addEventListener(`selectstart`,N),r.addEventListener(`selectend`,N),r.addEventListener(`squeeze`,N),r.addEventListener(`squeezestart`,N),r.addEventListener(`squeezeend`,N),r.addEventListener(`end`,re),r.addEventListener(`inputsourceschange`,ie),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new kt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new ni(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new kt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),de.setContext(r),de.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ie(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let P=new U,ae=new U;function oe(e,t,n){P.setFromMatrixPosition(t.matrixWorld),ae.setFromMatrixPosition(n.matrixWorld);let r=P.distanceTo(ae),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function se(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=te.near=k.near=t,A.far=te.far=k.far=n,(j!==A.near||M!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),j=A.near,M=A.far),A.layers.mask=e.layers.mask|6,k.layers.mask=A.layers.mask&-5,te.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;se(A,i);for(let e=0;e<a.length;e++)se(a[e],i);a.length===2?oe(A,k,te):A.projectionMatrix.copy(k.projectionMatrix),ce(e,A,i)};function ce(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=it*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let le=null;function ue(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=ne[n];o===void 0&&(o=new Zi,o.layers.enable(n),o.viewport=new Dt,ne[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new ii,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}le&&le(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let de=new wa;de.setAnimationLoop(ue),this.setAnimationLoop=function(e){le=e},this.dispose=function(){}}},Mc=new Ht,Nc=new Mt;function Pc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,mi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,Mc.copy(o),Mc.x*=-1,Mc.y*=-1,Mc.z*=-1,a.isCubeTexture&&a.isRenderTargetTexture===!1&&(Mc.y*=-1,Mc.z*=-1),e.envMapRotation.value.setFromMatrix4(Nc.makeRotationFromEuler(Mc)),e.flipEnvMap.value=a.isCubeTexture&&a.isRenderTargetTexture===!1?-1:1,e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Fc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return B(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?z(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):z(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var Ic=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Lc=null;function Rc(){return Lc===null&&(Lc=new Nr(Ic,16,16,O,g),Lc.name=`DFG_LUT`,Lc.minFilter=o,Lc.magFilter=o,Lc.wrapS=t,Lc.wrapT=t,Lc.generateMipmaps=!1,Lc.needsUpdate=!0),Lc}var zc=class{constructor(e={}){let{canvas:t=qe(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=null,O=null,ne=[],A=[],j=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,N=!1;this._outputColorSpace=Le;let re=0,ie=0,P=null,ae=-1,oe=null,se=new Dt,ce=new Dt,le=null,ue=new q(0),de=0,fe=t.width,pe=t.height,me=1,he=null,ge=null,_e=new Dt(0,0,fe,pe),ve=new Dt(0,0,fe,pe),ye=!1,be=new Vr,xe=!1,Se=!1,Ce=new Mt,we=new U,Te=new Dt,Ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},De=!1;function Oe(){return P===null?me:1}let F=n;function ke(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r183`),t.addEventListener(`webglcontextlost`,at,!1),t.addEventListener(`webglcontextrestored`,V,!1),t.addEventListener(`webglcontextcreationerror`,ot,!1),F===null){let t=`webgl2`;if(F=ke(t,e),F===null)throw ke(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw B(`WebGLRenderer: `+e.message),e}let Ae,je,I,Me,L,R,Ne,Pe,Fe,Ie,ze,Be,Ve,He,We,Ge,Ke,Je,Ye,Ze,et,tt,nt;function rt(){Ae=new ro(F),Ae.init(),et=new Dc(F,Ae),je=new Na(F,Ae,e,et),I=new Tc(F,Ae),je.reversedDepthBuffer&&h&&I.buffers.depth.setReversed(!0),Me=new oo(F),L=new ac,R=new Ec(F,Ae,I,L,je,et,Me),Ne=new no(M),Pe=new Ta(F),tt=new ja(F,Pe),Fe=new io(F,Pe,Me,tt),Ie=new co(F,Fe,Pe,tt,Me),Je=new so(F,je,R),We=new Pa(L),ze=new ic(M,Ne,Ae,je,tt,We),Be=new Pc(M,L),Ve=new lc,He=new gc(Ae),Ke=new Aa(M,Ne,I,Ie,x,s),Ge=new wc(M,Ie,je),nt=new Fc(F,Me,je,I),Ye=new Ma(F,Ae,Me),Ze=new ao(F,Ae,Me),Me.programs=ze.programs,M.capabilities=je,M.extensions=Ae,M.properties=L,M.renderLists=Ve,M.shadowMap=Ge,M.state=I,M.info=Me}rt(),S!==1009&&(j=new uo(S,t.width,t.height,r,i));let it=new jc(M,F);this.xr=it,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let e=Ae.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Ae.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return me},this.setPixelRatio=function(e){e!==void 0&&(me=e,this.setSize(fe,pe,!1))},this.getSize=function(e){return e.set(fe,pe)},this.setSize=function(e,n,r=!0){if(it.isPresenting){z(`WebGLRenderer: Can't change size while VR device is presenting.`);return}fe=e,pe=n,t.width=Math.floor(e*me),t.height=Math.floor(n*me),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),j!==null&&j.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(fe*me,pe*me).floor()},this.setDrawingBufferSize=function(e,n,r){fe=e,pe=n,me=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){console.error(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){console.warn(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}j.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(se)},this.getViewport=function(e){return e.copy(_e)},this.setViewport=function(e,t,n,r){e.isVector4?_e.set(e.x,e.y,e.z,e.w):_e.set(e,t,n,r),I.viewport(se.copy(_e).multiplyScalar(me).round())},this.getScissor=function(e){return e.copy(ve)},this.setScissor=function(e,t,n,r){e.isVector4?ve.set(e.x,e.y,e.z,e.w):ve.set(e,t,n,r),I.scissor(ce.copy(ve).multiplyScalar(me).round())},this.getScissorTest=function(){return ye},this.setScissorTest=function(e){I.setScissorTest(ye=e)},this.setOpaqueSort=function(e){he=e},this.setTransparentSort=function(e){ge=e},this.getClearColor=function(e){return e.copy(Ke.getClearColor())},this.setClearColor=function(){Ke.setClearColor(...arguments)},this.getClearAlpha=function(){return Ke.getClearAlpha()},this.setClearAlpha=function(){Ke.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(P!==null){let t=P.texture.format;e=C.has(t)}if(e){let e=P.texture.type,t=w.has(e),n=Ke.getClearColor(),r=Ke.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,F.clearBufferuiv(F.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,F.clearBufferiv(F.COLOR,0,E))}else r|=F.COLOR_BUFFER_BIT}t&&(r|=F.DEPTH_BUFFER_BIT),n&&(r|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&F.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener(`webglcontextlost`,at,!1),t.removeEventListener(`webglcontextrestored`,V,!1),t.removeEventListener(`webglcontextcreationerror`,ot,!1),Ke.dispose(),Ve.dispose(),He.dispose(),L.dispose(),Ne.dispose(),Ie.dispose(),tt.dispose(),nt.dispose(),ze.dispose(),it.dispose(),it.removeEventListener(`sessionstart`,ft),it.removeEventListener(`sessionend`,W),pt.stop()};function at(e){e.preventDefault(),Xe(`WebGLRenderer: Context Lost.`),N=!0}function V(){Xe(`WebGLRenderer: Context Restored.`),N=!1;let e=Me.autoReset,t=Ge.enabled,n=Ge.autoUpdate,r=Ge.needsUpdate,i=Ge.type;rt(),Me.autoReset=e,Ge.enabled=t,Ge.autoUpdate=n,Ge.needsUpdate=r,Ge.type=i}function ot(e){B(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function st(e){let t=e.target;t.removeEventListener(`dispose`,st),ct(t)}function ct(e){lt(e),L.remove(e)}function lt(e){let t=L.get(e).programs;t!==void 0&&(t.forEach(function(e){ze.releaseProgram(e)}),e.isShaderMaterial&&ze.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Ee);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=St(e,t,n,r,i);I.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Fe.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;tt.setup(i,r,s,n,c);let h,g=Ye;if(c!==null&&(h=Pe.get(c),g=Ze,g.setIndex(h)),i.isMesh)r.wireframe===!0?(I.setLineWidth(r.wireframeLinewidth*Oe()),g.setMode(F.LINES)):g.setMode(F.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),I.setLineWidth(e*Oe()),i.isLineSegments?g.setMode(F.LINES):i.isLineLoop?g.setMode(F.LINE_LOOP):g.setMode(F.LINE_STRIP)}else i.isPoints?g.setMode(F.POINTS):i.isSprite&&g.setMode(F.TRIANGLES);if(i.isBatchedMesh)if(i._multiDrawInstances!==null)Qe(`WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection.`),g.renderMultiDrawInstances(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount,i._multiDrawInstances);else if(Ae.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Pe.get(c).bytesPerElement:1,o=L.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(F,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function H(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,yt(e,t,n),e.side=0,e.needsUpdate=!0,yt(e,t,n),e.side=2):yt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),O=He.get(n),O.init(t),A.push(O),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),O.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];H(a,n,e),r.add(a)}else H(t,n,e),r.add(t)}),O=A.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){L.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Ae.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ut=null;function dt(e){ut&&ut(e)}function ft(){pt.stop()}function W(){pt.start()}let pt=new wa;pt.setAnimationLoop(dt),typeof self<`u`&&pt.setContext(self),this.setAnimationLoop=function(e){ut=e,it.setAnimationLoop(e),e===null?pt.stop():pt.start()},it.addEventListener(`sessionstart`,ft),it.addEventListener(`sessionend`,W),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){B(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(N===!0)return;let n=it.enabled===!0&&it.isPresenting===!0,r=j!==null&&(P===null||n)&&j.begin(M,P);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),it.enabled===!0&&it.isPresenting===!0&&(j===null||j.isCompositing()===!1)&&(it.cameraAutoUpdate===!0&&it.updateCamera(t),t=it.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,P),O=He.get(e,A.length),O.init(t),A.push(O),Ce.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),be.setFromProjectionMatrix(Ce,Ue,t.reversedDepth),Se=this.localClippingEnabled,xe=We.init(this.clippingPlanes,Se),D=Ve.get(e,ne.length),D.init(),ne.push(D),it.enabled===!0&&it.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&mt(e,t,-1/0,M.sortObjects)}mt(e,t,0,M.sortObjects),D.finish(),M.sortObjects===!0&&D.sort(he,ge),De=it.enabled===!1||it.isPresenting===!1||it.hasDepthSensing()===!1,De&&Ke.addToRenderList(D,e),this.info.render.frame++,xe===!0&&We.beginShadows();let i=O.state.shadowsArray;if(Ge.render(i,e,t),xe===!0&&We.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&j.hasRenderPass())===!1){let n=D.opaque,r=D.transmissive;if(O.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];gt(n,r,e,a)}De&&Ke.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];ht(D,e,n,n.viewport)}}else r.length>0&&gt(n,r,e,t),De&&Ke.render(e),ht(D,e,t)}P!==null&&ie===0&&(R.updateMultisampleRenderTarget(P),R.updateRenderTargetMipmap(P)),r&&j.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),tt.resetDefaultState(),ae=-1,oe=null,A.pop(),A.length>0?(O=A[A.length-1],xe===!0&&We.setGlobalState(M.clippingPlanes,O.state.camera)):O=null,ne.pop(),D=ne.length>0?ne[ne.length-1]:null};function mt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLight)O.pushLight(e),e.castShadow&&O.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||be.intersectsSprite(e)){r&&Te.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ce);let t=Ie.update(e),i=e.material;i.visible&&D.push(e,t,i,n,Te.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||be.intersectsObject(e))){let t=Ie.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Te.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Te.copy(e.boundingSphere.center)),Te.applyMatrix4(e.matrixWorld).applyMatrix4(Ce)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&D.push(e,t,s,n,Te.z,o)}}else i.visible&&D.push(e,t,i,n,Te.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)mt(i[e],t,n,r)}function ht(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;O.setupLightsView(n),xe===!0&&We.setGlobalState(M.clippingPlanes,n),r&&I.viewport(se.copy(r)),i.length>0&&_t(i,t,n),a.length>0&&_t(a,t,n),o.length>0&&_t(o,t,n),I.buffers.depth.setTest(!0),I.buffers.depth.setMask(!0),I.buffers.color.setMask(!0),I.setPolygonOffset(!1)}function gt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(O.state.transmissionRenderTarget[r.id]===void 0){let e=Ae.has(`EXT_color_buffer_half_float`)||Ae.has(`EXT_color_buffer_float`);O.state.transmissionRenderTarget[r.id]=new kt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,je.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:G.workingColorSpace})}let a=O.state.transmissionRenderTarget[r.id],o=r.viewport||se;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),u=M.getActiveCubeFace(),d=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(ue),de=M.getClearAlpha(),de<1&&M.setClearColor(16777215,.5),M.clear(),De&&Ke.render(n);let f=M.toneMapping;M.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),O.setupLightsView(r),xe===!0&&We.setGlobalState(M.clippingPlanes,r),_t(e,n,r),R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a),Ae.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,vt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a))}M.setRenderTarget(s,u,d),M.setClearColor(ue,de),p!==void 0&&(r.viewport=p),M.toneMapping=f}function _t(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&vt(o,t,n,s,l,c)}}function vt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function yt(e,t,n){t.isScene!==!0&&(t=Ee);let r=L.get(e),i=O.state.lights,a=O.state.shadowsArray,o=i.state.version,s=ze.getParameters(e,i.state,a,t,n),c=ze.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ne.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,st),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return xt(e,s),d}else s.uniforms=ze.getUniforms(e),e.onBeforeCompile(s,M),d=ze.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=We.uniform),xt(e,s),r.needsLights=wt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.currentProgram=d,r.uniformsList=null,d}function bt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=vs.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function xt(e,t){let n=L.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function St(e,t,n,r,i){t.isScene!==!0&&(t=Ee),R.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=P===null?M.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:Re,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ne.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=L.get(r),y=O.state.lights;if(xe===!0&&(Se===!0||e!==oe)){let t=e===oe&&r.id===ae;We.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==We.numPlanes||v.numIntersection!==We.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h?v.morphTargetsCount!==_&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=yt(r,t,i));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(I.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ae&&(ae=r.id,C=!0),S||oe!==e){I.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(F,`projectionMatrix`,e.projectionMatrix),T.setValue(F,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(F,we.setFromMatrixPosition(e.matrixWorld)),je.logarithmicDepthBuffer&&T.setValue(F,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(F,`isOrthographic`,e.isOrthographicCamera===!0),oe!==e&&(oe=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(F,`directionalShadowMap`,y.state.directionalShadowMap,R),y.state.spotShadowMap.length>0&&T.setValue(F,`spotShadowMap`,y.state.spotShadowMap,R),y.state.pointShadowMap.length>0&&T.setValue(F,`pointShadowMap`,y.state.pointShadowMap,R)),i.isSkinnedMesh){T.setOptional(F,i,`bindMatrix`),T.setOptional(F,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(F,`boneTexture`,e.boneTexture,R))}i.isBatchedMesh&&(T.setOptional(F,i,`batchingTexture`),T.setValue(F,`batchingTexture`,i._matricesTexture,R),T.setOptional(F,i,`batchingIdTexture`),T.setValue(F,`batchingIdTexture`,i._indirectTexture,R),T.setOptional(F,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(F,`batchingColorTexture`,i._colorsTexture,R));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Je.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(F,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Rc()),C&&(T.setValue(F,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&Ct(E,w),a&&r.fog===!0&&Be.refreshFogUniforms(E,a),Be.refreshMaterialUniforms(E,r,me,pe,O.state.transmissionRenderTarget[e.id]),vs.upload(F,bt(v),E,R)),r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(vs.upload(F,bt(v),E,R),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(F,`center`,i.center),T.setValue(F,`modelViewMatrix`,i.modelViewMatrix),T.setValue(F,`normalMatrix`,i.normalMatrix),T.setValue(F,`modelMatrix`,i.matrixWorld),r.isShaderMaterial||r.isRawShaderMaterial){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];nt.update(n,x),nt.bind(n,x)}}return x}function Ct(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function wt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return re},this.getActiveMipmapLevel=function(){return ie},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(e,t,n){let r=L.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),L.get(e.texture).__webglTexture=t,L.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=L.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let Tt=F.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){P=e,re=t,ie=n;let r=null,i=!1,a=!1;if(e){let o=L.get(e);if(o.__useDefaultFramebuffer!==void 0){I.bindFramebuffer(F.FRAMEBUFFER,o.__webglFramebuffer),se.copy(e.viewport),ce.copy(e.scissor),le=e.scissorTest,I.viewport(se),I.scissor(ce),I.setScissorTest(le),ae=-1;return}else if(o.__webglFramebuffer===void 0)R.setupRenderTarget(e);else if(o.__hasExternalTextures)R.rebindTextures(e,L.get(e.texture).__webglTexture,L.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&L.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);R.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=L.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&R.useMultisampledRTT(e)===!1?L.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,se.copy(e.viewport),ce.copy(e.scissor),le=e.scissorTest}else se.copy(_e).multiplyScalar(me).floor(),ce.copy(ve).multiplyScalar(me).floor(),le=ye;if(n!==0&&(r=Tt),I.bindFramebuffer(F.FRAMEBUFFER,r)&&I.drawBuffers(e,r),I.viewport(se),I.scissor(ce),I.setScissorTest(le),i){let r=L.get(e.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=L.get(e.textures[t]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=L.get(e.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,t.__webglTexture,n)}ae=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){I.bindFramebuffer(F.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+s),!je.textureFormatReadable(c)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!je.textureTypeReadable(l)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&F.readPixels(t,n,r,i,et.convert(c),et.convert(l),a)}finally{let e=P===null?null:L.get(P).__webglFramebuffer;I.bindFramebuffer(F.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){I.bindFramebuffer(F.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+s),!je.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!je.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,d),F.bufferData(F.PIXEL_PACK_BUFFER,a.byteLength,F.STREAM_READ),F.readPixels(t,n,r,i,et.convert(l),et.convert(u),0);let f=P===null?null:L.get(P).__webglFramebuffer;I.bindFramebuffer(F.FRAMEBUFFER,f);let p=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await $e(F,p,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,d),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,a),F.deleteBuffer(d),F.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;R.setTexture2D(e,0),F.copyTexSubImage2D(F.TEXTURE_2D,n,0,0,o,s,i,a),I.unbindTexture()};let Et=F.createFramebuffer(),Ot=F.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=et.convert(t.format),_=et.convert(t.type),v;t.isData3DTexture?(R.setTexture3D(t,0),v=F.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(R.setTexture2DArray(t,0),v=F.TEXTURE_2D_ARRAY):(R.setTexture2D(t,0),v=F.TEXTURE_2D),F.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,t.flipY),F.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),F.pixelStorei(F.UNPACK_ALIGNMENT,t.unpackAlignment);let y=F.getParameter(F.UNPACK_ROW_LENGTH),b=F.getParameter(F.UNPACK_IMAGE_HEIGHT),x=F.getParameter(F.UNPACK_SKIP_PIXELS),S=F.getParameter(F.UNPACK_SKIP_ROWS),C=F.getParameter(F.UNPACK_SKIP_IMAGES);F.pixelStorei(F.UNPACK_ROW_LENGTH,h.width),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,h.height),F.pixelStorei(F.UNPACK_SKIP_PIXELS,l),F.pixelStorei(F.UNPACK_SKIP_ROWS,u),F.pixelStorei(F.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=L.get(e),r=L.get(t),h=L.get(n.__renderTarget),g=L.get(r.__renderTarget);I.bindFramebuffer(F.READ_FRAMEBUFFER,h.__webglFramebuffer),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,L.get(e).__webglTexture,i,d+n),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,L.get(t).__webglTexture,a,m+n)),F.blitFramebuffer(l,u,o,s,f,p,o,s,F.DEPTH_BUFFER_BIT,F.NEAREST);I.bindFramebuffer(F.READ_FRAMEBUFFER,null),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||L.has(e)){let n=L.get(e),r=L.get(t);I.bindFramebuffer(F.READ_FRAMEBUFFER,Et),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,Ot);for(let e=0;e<c;e++)w?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,n.__webglTexture,i),T?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,r.__webglTexture,a),i===0?T?F.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):F.copyTexSubImage2D(v,a,f,p,l,u,o,s):F.blitFramebuffer(l,u,o,s,f,p,o,s,F.COLOR_BUFFER_BIT,F.NEAREST);I.bindFramebuffer(F.READ_FRAMEBUFFER,null),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?F.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?F.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):F.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):F.texSubImage2D(F.TEXTURE_2D,a,f,p,o,s,g,_,h);F.pixelStorei(F.UNPACK_ROW_LENGTH,y),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,b),F.pixelStorei(F.UNPACK_SKIP_PIXELS,x),F.pixelStorei(F.UNPACK_SKIP_ROWS,S),F.pixelStorei(F.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&F.generateMipmap(v),I.unbindTexture()},this.initRenderTarget=function(e){L.get(e).__webglFramebuffer===void 0&&R.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?R.setTextureCube(e,0):e.isData3DTexture?R.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?R.setTexture2DArray(e,0):R.setTexture2D(e,0),I.unbindTexture()},this.resetState=function(){re=0,ie=0,P=null,I.reset(),tt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ue}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=G._getDrawingBufferColorSpace(e),t.unpackColorSpace=G._getUnpackColorSpace()}},Bc=class{constructor(e){this.game=e,this.camera=new Zi(50,window.innerWidth/window.innerHeight,.1,100),this.targetPos=new U,this.currentPos=new U,this.lookAtTarget=new U,this.currentLookAt=new U,this.shakeOffset=new U,this.presets=[{offset:new U(0,12,14),lookOffset:new U(0,0,0)},{offset:new U(14,8,0),lookOffset:new U(0,0,0)},{offset:new U(-5,6,12),lookOffset:new U(0,1,0)},{offset:new U(10,14,10),lookOffset:new U(0,0,0)},{offset:new U(0,10,18),lookOffset:new U(0,1,0)}],this.currentPreset=0,this.transitionSpeed=2}init(){this.camera.position.set(0,12,14),this.currentPos.copy(this.camera.position),this.currentLookAt.set(0,0,0),this.camera.lookAt(0,0,0)}reset(){this.currentPreset=this.game.currentRoom%this.presets.length}onResize(e,t){this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}update(e){let t=this.game.player;if(!t)return;let n=this.presets[this.currentPreset],r=t.position;this.targetPos.copy(r).add(n.offset),this.lookAtTarget.copy(r).add(n.lookOffset);let i=1-Math.exp(-this.transitionSpeed*e);this.currentPos.lerp(this.targetPos,i),this.currentLookAt.lerp(this.lookAtTarget,i),this.camera.position.copy(this.currentPos).add(this.shakeOffset),this.camera.lookAt(this.currentLookAt)}applyShake(e){this.shakeOffset.set((Math.random()-.5)*2*e,(Math.random()-.5)*2*e,(Math.random()-.5)*2*e)}},Vc=class{constructor(e){this.game=e,this.moveX=0,this.moveY=0,this.attack=!1,this.attackPressed=!1,this.shoot=!1,this.jump=!1,this.jumpPressed=!1,this.dodge=!1,this.dodgePressed=!1,this.devilTrigger=!1,this.devilTriggerPressed=!1,this.lockOn=!1,this._prevAttack=!1,this._prevJump=!1,this._prevDodge=!1,this._prevDT=!1,this.keys={},window.addEventListener(`keydown`,e=>{this.keys[e.code]=!0}),window.addEventListener(`keyup`,e=>{this.keys[e.code]=!1})}update(){this.attackPressed=this.attack&&!this._prevAttack,this.jumpPressed=this.jump&&!this._prevJump,this.dodgePressed=this.dodge&&!this._prevDodge,this.devilTriggerPressed=this.devilTrigger&&!this._prevDT,this._prevAttack=this.attack,this._prevJump=this.jump,this._prevDodge=this.dodge,this._prevDT=this.devilTrigger,this.keys.KeyW||this.keys.ArrowUp?this.moveY=-1:this.keys.KeyS||this.keys.ArrowDown?this.moveY=1:this.game.touchControls.joystickActive||(this.moveY=0),this.keys.KeyA||this.keys.ArrowLeft?this.moveX=-1:this.keys.KeyD||this.keys.ArrowRight?this.moveX=1:this.game.touchControls.joystickActive||(this.moveX=0),this.keys.KeyJ&&(this.attack=!0),this.keys.KeyK&&(this.shoot=!0),this.keys.Space&&(this.jump=!0),this.keys.KeyL&&(this.dodge=!0),this.keys.KeyU&&(this.devilTrigger=!0)}getMoveMagnitude(){return Math.min(1,Math.sqrt(this.moveX*this.moveX+this.moveY*this.moveY))}getMoveAngle(){return Math.atan2(this.moveX,this.moveY)}hasMovement(){return this.getMoveMagnitude()>.15}},Hc=class{constructor(e){this.game=e,this.ctx=null,this.bgmGain=null,this.sfxGain=null,this.bgmSource=null,this.initialized=!1}init(){let e=()=>{this.initialized||=(this.ctx=new(window.AudioContext||window.webkitAudioContext),this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.3,this.bgmGain.connect(this.ctx.destination),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=.5,this.sfxGain.connect(this.ctx.destination),!0)};document.addEventListener(`touchstart`,e,{once:!0}),document.addEventListener(`click`,e,{once:!0})}playSFX(e){if(!this.initialized)return;let t=this.ctx,n=t.currentTime;switch(e){case`swordSwing`:{let e=t.createBufferSource(),r=t.createBuffer(1,t.sampleRate*.15,t.sampleRate),i=r.getChannelData(0);for(let e=0;e<i.length;e++)i[e]=(Math.random()*2-1)*(1-e/i.length);e.buffer=r;let a=t.createBiquadFilter();a.type=`bandpass`,a.frequency.setValueAtTime(2e3,n),a.frequency.exponentialRampToValueAtTime(500,n+.15),a.Q.value=2;let o=t.createGain();o.gain.setValueAtTime(.3,n),o.gain.exponentialRampToValueAtTime(.01,n+.15),e.connect(a).connect(o).connect(this.sfxGain),e.start(n);break}case`swordHit`:{let e=t.createOscillator();e.type=`sawtooth`,e.frequency.setValueAtTime(200,n),e.frequency.exponentialRampToValueAtTime(50,n+.1);let r=t.createGain();r.gain.setValueAtTime(.5,n),r.gain.exponentialRampToValueAtTime(.01,n+.15),e.connect(r).connect(this.sfxGain),e.start(n),e.stop(n+.15);let i=t.createBufferSource(),a=t.createBuffer(1,t.sampleRate*.08,t.sampleRate),o=a.getChannelData(0);for(let e=0;e<o.length;e++)o[e]=(Math.random()*2-1)*(1-e/o.length);i.buffer=a;let s=t.createGain();s.gain.setValueAtTime(.4,n),s.gain.exponentialRampToValueAtTime(.01,n+.08),i.connect(s).connect(this.sfxGain),i.start(n);break}case`gunshot`:{let e=t.createOscillator();e.type=`square`,e.frequency.setValueAtTime(400,n),e.frequency.exponentialRampToValueAtTime(80,n+.05);let r=t.createGain();r.gain.setValueAtTime(.25,n),r.gain.exponentialRampToValueAtTime(.01,n+.08),e.connect(r).connect(this.sfxGain),e.start(n),e.stop(n+.08);break}case`dodge`:{let e=t.createOscillator();e.type=`sine`,e.frequency.setValueAtTime(800,n),e.frequency.exponentialRampToValueAtTime(400,n+.1);let r=t.createGain();r.gain.setValueAtTime(.15,n),r.gain.exponentialRampToValueAtTime(.01,n+.1),e.connect(r).connect(this.sfxGain),e.start(n),e.stop(n+.1);break}case`devilTrigger`:for(let e=0;e<3;e++){let r=t.createOscillator();r.type=`sawtooth`,r.frequency.setValueAtTime(100+e*100,n),r.frequency.exponentialRampToValueAtTime(400+e*200,n+.5);let i=t.createGain();i.gain.setValueAtTime(.2,n),i.gain.linearRampToValueAtTime(.3,n+.2),i.gain.exponentialRampToValueAtTime(.01,n+.5),r.connect(i).connect(this.sfxGain),r.start(n),r.stop(n+.5)}break;case`enemyHit`:{let e=t.createOscillator();e.type=`triangle`,e.frequency.setValueAtTime(150,n),e.frequency.exponentialRampToValueAtTime(60,n+.1);let r=t.createGain();r.gain.setValueAtTime(.3,n),r.gain.exponentialRampToValueAtTime(.01,n+.1),e.connect(r).connect(this.sfxGain),e.start(n),e.stop(n+.1);break}case`enemyDeath`:{let e=t.createBufferSource(),r=t.createBuffer(1,t.sampleRate*.4,t.sampleRate),i=r.getChannelData(0);for(let e=0;e<i.length;e++)i[e]=(Math.random()*2-1)*(1-e/i.length)**2;e.buffer=r;let a=t.createGain();a.gain.setValueAtTime(.4,n),a.gain.exponentialRampToValueAtTime(.01,n+.4),e.connect(a).connect(this.sfxGain),e.start(n);break}case`playerHit`:{let e=t.createOscillator();e.type=`sawtooth`,e.frequency.setValueAtTime(300,n),e.frequency.exponentialRampToValueAtTime(100,n+.2);let r=t.createGain();r.gain.setValueAtTime(.4,n),r.gain.exponentialRampToValueAtTime(.01,n+.2),e.connect(r).connect(this.sfxGain),e.start(n),e.stop(n+.2);break}case`gameOver`:for(let e=0;e<4;e++){let r=t.createOscillator();r.type=`sine`,r.frequency.setValueAtTime(400-e*80,n+e*.3);let i=t.createGain();i.gain.setValueAtTime(0,n+e*.3),i.gain.linearRampToValueAtTime(.2,n+e*.3+.05),i.gain.exponentialRampToValueAtTime(.01,n+e*.3+.3),r.connect(i).connect(this.sfxGain),r.start(n+e*.3),r.stop(n+e*.3+.3)}break;case`victory`:{let e=[523,659,784,1047];for(let r=0;r<e.length;r++){let i=t.createOscillator();i.type=`triangle`,i.frequency.value=e[r];let a=t.createGain();a.gain.setValueAtTime(0,n+r*.15),a.gain.linearRampToValueAtTime(.2,n+r*.15+.05),a.gain.exponentialRampToValueAtTime(.01,n+r*.15+.4),i.connect(a).connect(this.sfxGain),i.start(n+r*.15),i.stop(n+r*.15+.4)}break}case`doorOpen`:{let e=t.createOscillator();e.type=`sine`,e.frequency.setValueAtTime(200,n),e.frequency.linearRampToValueAtTime(600,n+.3);let r=t.createGain();r.gain.setValueAtTime(.2,n),r.gain.exponentialRampToValueAtTime(.01,n+.4),e.connect(r).connect(this.sfxGain),e.start(n),e.stop(n+.4);break}case`styleUp`:{let e=t.createOscillator();e.type=`triangle`,e.frequency.setValueAtTime(600,n),e.frequency.linearRampToValueAtTime(1200,n+.15);let r=t.createGain();r.gain.setValueAtTime(.2,n),r.gain.exponentialRampToValueAtTime(.01,n+.2),e.connect(r).connect(this.sfxGain),e.start(n),e.stop(n+.2);break}}}playBGM(){if(!this.initialized)return;this.stopBGM();let e=this.ctx,t=e.sampleRate,n=t*8,r=e.createBuffer(2,n,t);for(let e=0;e<2;e++){let i=r.getChannelData(e);for(let r=0;r<n;r++){let n=r/t,a=n*2.5,o=a%1,s=0;if(o<.1){let e=1-o/.1;s+=Math.sin(2*Math.PI*(80-40*o)*n)*e*.3}let c=Math.floor(a)%4<2?55:62,l=n*c*2%1*2-1,u=n*c*3%1*2-1;s+=Math.tanh(l*3)*.08+Math.tanh(u*3)*.06,o>.5&&o<.55&&(s+=(Math.random()*2-1)*.05*(1-(o-.5)/.05));let d=a%4;if(d>1&&d<1.08||d>3&&d<3.08){let e=1-(d%1-Math.floor(d%1))/.08;s+=(Math.random()*2-1)*.12*Math.max(0,e)}let f=e===0?220:221;s+=Math.sin(2*Math.PI*f*n)*.02,s+=Math.sin(2*Math.PI*f*1.5*n)*.015,i[r]=s*.7}}this.bgmSource=e.createBufferSource(),this.bgmSource.buffer=r,this.bgmSource.loop=!0,this.bgmSource.connect(this.bgmGain),this.bgmSource.start()}stopBGM(){if(this.bgmSource){try{this.bgmSource.stop()}catch{}this.bgmSource=null}}pauseBGM(){this.ctx&&this.ctx.state===`running`&&this.ctx.suspend()}resumeAudio(){this.ctx&&this.ctx.state===`suspended`&&this.ctx.resume()}},Uc=class{constructor(e,t,n){this.owner=e,this.states=t,this.current=n,this.previous=null,this.stateTime=0,this.states[this.current]?.enter&&this.states[this.current].enter(this.owner)}transition(e){e!==this.current&&this.states[e]&&(this.states[this.current]?.exit&&this.states[this.current].exit(this.owner),this.previous=this.current,this.current=e,this.stateTime=0,this.states[this.current]?.enter&&this.states[this.current].enter(this.owner))}update(e){this.stateTime+=e,this.states[this.current]?.update&&this.states[this.current].update(this.owner,e,this.stateTime)}is(e){return this.current===e}},Wc=class{constructor(e){this.game=e,this.position=new U(0,0,0),this.velocity=new U,this.rotation=0,this.mesh=null,this.maxHP=100,this.hp=100,this.speed=6,this.runSpeed=9,this.dodgeSpeed=15,this.gravity=-25,this.jumpForce=10,this.yVelocity=0,this.grounded=!0,this.invulnerable=!1,this.invulnerableTimer=0,this.attackTimer=0,this.attackDuration=0,this.comboStep=0,this.comboTimer=0,this.comboWindow=.4,this.currentAttackType=`none`,this.currentHitEnemies=new Set,this.shootCooldown=0,this.dodgeTimer=0,this.dtGauge=0,this.maxDT=100,this.dtActive=!1,this.dtDrainRate=15,this.dtDamageMultiplier=1.5,this.dtRegenRate=2,this.swordTip=new U,this.animTime=0,this.flashTimer=0,this.fsm=new Uc(this,{idle:{enter:e=>{e.animTime=0},update:(e,t)=>{e.idleAnim(t),e.checkTransitions(t)}},walk:{update:(e,t)=>{e.moveAnim(t),e.applyMovement(t,e.speed),e.checkTransitions(t)}},run:{update:(e,t)=>{e.moveAnim(t*1.5),e.applyMovement(t,e.runSpeed),e.checkTransitions(t)}},attack1:{enter:e=>{e.attackTimer=0,e.attackDuration=.35,e.currentAttackType=`sword1`,e.currentHitEnemies.clear(),e.comboStep=1,e.game.audio.playSFX(`swordSwing`)},update:(e,t,n)=>{e.attackAnim(t,1),e.attackTimer+=t,e.attackTimer>=e.attackDuration&&(e.comboTimer=e.comboWindow,e.game.input.attackPressed||e.game.input.attack?e.fsm.transition(`attack2`):e.fsm.transition(`idle`))}},attack2:{enter:e=>{e.attackTimer=0,e.attackDuration=.3,e.currentAttackType=`sword2`,e.currentHitEnemies.clear(),e.comboStep=2,e.game.audio.playSFX(`swordSwing`)},update:(e,t)=>{e.attackAnim(t,2),e.attackTimer+=t,e.attackTimer>=e.attackDuration&&(e.game.input.attackPressed||e.game.input.attack?e.fsm.transition(`attack3`):e.fsm.transition(`idle`))}},attack3:{enter:e=>{e.attackTimer=0,e.attackDuration=.5,e.currentAttackType=`sword3`,e.currentHitEnemies.clear(),e.comboStep=3,e.game.audio.playSFX(`swordSwing`);let t=e.getForward();e.velocity.x=t.x*5,e.velocity.z=t.z*5},update:(e,t)=>{e.attackAnim(t,3),e.attackTimer+=t,e.velocity.x*=.9,e.velocity.z*=.9,e.position.x+=e.velocity.x*t,e.position.z+=e.velocity.z*t,e.attackTimer>=e.attackDuration&&e.fsm.transition(`idle`)}},stinger:{enter:e=>{e.attackTimer=0,e.attackDuration=.4,e.currentAttackType=`stinger`,e.currentHitEnemies.clear(),e.game.audio.playSFX(`swordSwing`);let t=e.getForward();e.velocity.x=t.x*18,e.velocity.z=t.z*18},update:(e,t)=>{e.stingerAnim(t),e.attackTimer+=t,e.velocity.x*=.92,e.velocity.z*=.92,e.position.x+=e.velocity.x*t,e.position.z+=e.velocity.z*t,e.attackTimer>=e.attackDuration&&e.fsm.transition(`idle`)}},highTime:{enter:e=>{e.attackTimer=0,e.attackDuration=.45,e.currentAttackType=`highTime`,e.currentHitEnemies.clear(),e.yVelocity=8,e.grounded=!1,e.game.audio.playSFX(`swordSwing`)},update:(e,t)=>{e.highTimeAnim(t),e.attackTimer+=t,e.yVelocity+=e.gravity*t,e.position.y+=e.yVelocity*t,e.position.y<=0&&(e.position.y=0,e.grounded=!0),e.attackTimer>=e.attackDuration&&(e.grounded?e.fsm.transition(`idle`):e.fsm.transition(`aerial`))}},aerial:{enter:e=>{e.attackTimer=0,e.attackDuration=.3,e.currentAttackType=`aerial`,e.currentHitEnemies.clear()},update:(e,t)=>{if(e.aerialAnim(t),e.attackTimer+=t,e.yVelocity+=e.gravity*t,e.position.y+=e.yVelocity*t,e.position.y<=0){e.position.y=0,e.grounded=!0,e.fsm.transition(`idle`);return}e.attackTimer>=e.attackDuration&&(e.game.input.attackPressed?(e.currentHitEnemies.clear(),e.attackTimer=0,e.game.audio.playSFX(`swordSwing`)):e.fsm.transition(`fall`))}},fall:{update:(e,t)=>{e.yVelocity+=e.gravity*t,e.position.y+=e.yVelocity*t,e.position.y<=0&&(e.position.y=0,e.grounded=!0,e.fsm.transition(`idle`))}},shoot:{enter:e=>{e.attackTimer=0,e.shootCooldown=0},update:(e,t)=>{e.shootAnim(t),e.attackTimer+=t,e.shootCooldown-=t,e.shootCooldown<=0&&e.game.input.shoot&&(e.fireGun(),e.shootCooldown=.12),e.game.input.shoot||e.fsm.transition(`idle`),e.game.input.attackPressed&&e.fsm.transition(`attack1`)}},dodge:{enter:e=>{e.dodgeTimer=.35,e.invulnerable=!0,e.game.audio.playSFX(`dodge`);let t=e.game.input;if(t.hasMovement()){let n=t.getMoveAngle();e.velocity.x=Math.sin(n)*e.dodgeSpeed,e.velocity.z=Math.cos(n)*e.dodgeSpeed}else{let t=e.getForward();e.velocity.x=-t.x*e.dodgeSpeed,e.velocity.z=-t.z*e.dodgeSpeed}},update:(e,t)=>{e.dodgeAnim(t),e.dodgeTimer-=t,e.velocity.x*=.88,e.velocity.z*=.88,e.position.x+=e.velocity.x*t,e.position.z+=e.velocity.z*t,e.dodgeTimer<=0&&(e.invulnerable=!1,e.fsm.transition(`idle`))}},jump:{enter:e=>{e.yVelocity=e.jumpForce,e.grounded=!1},update:(e,t)=>{e.jumpAnim(t),e.yVelocity+=e.gravity*t,e.position.y+=e.yVelocity*t;let n=e.game.input;if(n.hasMovement()){let r=n.getMoveAngle();e.position.x+=Math.sin(r)*e.speed*.7*t,e.position.z+=Math.cos(r)*e.speed*.7*t,e.rotation=r}e.position.y<=0&&(e.position.y=0,e.grounded=!0,e.fsm.transition(`idle`)),e.game.input.attackPressed&&e.fsm.transition(`aerial`)}},hit:{enter:e=>{e.attackTimer=0,e.invulnerable=!0,e.invulnerableTimer=.8},update:(e,t)=>{e.hitAnim(t),e.attackTimer+=t,e.velocity.x*=.9,e.velocity.z*=.9,e.position.x+=e.velocity.x*t,e.position.z+=e.velocity.z*t,e.attackTimer>.3&&e.fsm.transition(`idle`)}},dead:{enter:e=>{e.animTime=0},update:(e,t)=>{e.deadAnim(t)}}},`idle`)}init(){this.buildModel(),this.game.scene.add(this.mesh)}buildModel(){this.mesh=new K;let e=new Z({color:13369344}),t=new Z({color:16107168}),n=new Z({color:2236962}),r=new Z({color:11184844}),i=new Z({color:15658734}),a=new Y(new X(.6,.8,.35),e);a.position.y=1.3,a.castShadow=!0,this.mesh.add(a),this.torso=a;let o=new Y(new X(.25,.7,.15),e);o.position.set(-.15,.55,-.1),o.castShadow=!0,this.mesh.add(o),this.coatTailL=o;let s=new Y(new X(.25,.7,.15),e);s.position.set(.15,.55,-.1),s.castShadow=!0,this.mesh.add(s),this.coatTailR=s;let c=new Y(new li(.18,8,8),t);c.position.y=1.9,c.castShadow=!0,this.mesh.add(c),this.head=c;let l=new Y(new oi(.2,.25,6),i);l.position.y=2.1,l.castShadow=!0,this.mesh.add(l),this.leftArm=new K,this.leftArm.position.set(-.4,1.55,0);let u=new Y(new X(.15,.55,.15),e);u.position.y=-.25,this.leftArm.add(u),this.mesh.add(this.leftArm),this.rightArm=new K,this.rightArm.position.set(.4,1.55,0);let d=new Y(new X(.15,.55,.15),e);d.position.y=-.25,this.rightArm.add(d),this.mesh.add(this.rightArm),this.leftLeg=new K,this.leftLeg.position.set(-.15,.9,0);let f=new Y(new X(.18,.7,.18),n);f.position.y=-.35,this.leftLeg.add(f);let p=new Y(new X(.2,.2,.25),n);p.position.set(0,-.7,.03),this.leftLeg.add(p),this.mesh.add(this.leftLeg),this.rightLeg=new K,this.rightLeg.position.set(.15,.9,0);let m=new Y(new X(.18,.7,.18),n);m.position.y=-.35,this.rightLeg.add(m);let h=new Y(new X(.2,.2,.25),n);h.position.set(0,-.7,.03),this.rightLeg.add(h),this.mesh.add(this.rightLeg),this.sword=new K;let g=new Y(new X(.06,1.4,.02),r);g.position.y=.7,this.sword.add(g);let _=new Y(new X(.2,.15,.06),new Z({color:9127187}));this.sword.add(_);let v=new Y(new X(.3,.06,.08),r);v.position.y=.05,this.sword.add(v),this.sword.position.set(.1,1.2,-.25),this.sword.rotation.z=.1,this.mesh.add(this.sword);let y=new Z({color:3355443});this.gunL=new Y(new X(.06,.04,.2),y),this.gunL.position.set(-.35,.9,.05),this.mesh.add(this.gunL),this.gunR=new Y(new X(.06,.04,.2),y),this.gunR.position.set(.35,.9,.05),this.mesh.add(this.gunR),this.dtAura=new $i(16711680,0,5),this.dtAura.position.y=1.3,this.mesh.add(this.dtAura),this.dtOverlay=new Y(new li(1,8,8),new yr({color:16711680,transparent:!0,opacity:0,wireframe:!0})),this.dtOverlay.position.y=1,this.mesh.add(this.dtOverlay)}reset(){this.hp=this.maxHP,this.dtGauge=0,this.dtActive=!1,this.position.set(0,0,0),this.velocity.set(0,0,0),this.rotation=0,this.yVelocity=0,this.grounded=!0,this.invulnerable=!1,this.invulnerableTimer=0,this.comboStep=0,this.comboTimer=0,this.fsm.transition(`idle`),this.updateMeshTransform()}enterRoom(){this.position.set(0,0,5),this.rotation=Math.PI,this.velocity.set(0,0,0),this.updateMeshTransform()}update(e){this.invulnerableTimer>0?(this.invulnerableTimer-=e,this.invulnerableTimer<=0&&(this.invulnerable=!1),this.flashTimer+=e*15,this.mesh.visible=Math.sin(this.flashTimer)>0):(this.mesh.visible=!0,this.flashTimer=0),this.comboTimer>0&&(this.comboTimer-=e,this.comboTimer<=0&&(this.comboStep=0)),this.dtActive&&(this.dtGauge-=this.dtDrainRate*e,this.hp=Math.min(this.maxHP,this.hp+this.dtRegenRate*e),this.dtAura.intensity=3+Math.sin(Date.now()*.01)*1,this.dtOverlay.material.opacity=.15+Math.sin(Date.now()*.008)*.05,this.dtOverlay.rotation.y+=e*2,this.dtGauge<=0&&this.deactivateDT()),this.fsm.update(e),this.updateMeshTransform()}checkTransitions(e){let t=this.game.input;if(this.hp<=0){this.fsm.transition(`dead`),this.game.gameOver();return}if(t.devilTriggerPressed&&this.dtGauge>=30&&!this.dtActive?this.activateDT():t.devilTriggerPressed&&this.dtActive&&this.deactivateDT(),t.dodgePressed&&this.grounded){this.fsm.transition(`dodge`);return}if(t.jumpPressed&&this.grounded){this.fsm.transition(`jump`);return}if(t.attackPressed){if(t.hasMovement()&&this.comboStep===0&&t.getMoveMagnitude()>.8){this.fsm.transition(`stinger`);return}if(t.jumpPressed||!this.grounded){this.fsm.transition(`highTime`);return}this.fsm.transition(`attack1`);return}if(t.shoot&&!t.attack){this.fsm.transition(`shoot`);return}if(t.hasMovement()){let e=t.getMoveMagnitude();this.fsm.transition(e>.7?`run`:`walk`)}else (this.fsm.current===`walk`||this.fsm.current===`run`)&&this.fsm.transition(`idle`)}applyMovement(e,t){let n=this.game.input;if(!n.hasMovement())return;let r=n.getMoveAngle()+Math.atan2(this.game.camera.camera.position.x-this.position.x,this.game.camera.camera.position.z-this.position.z);this.position.x+=Math.sin(r)*t*e,this.position.z+=Math.cos(r)*t*e,this.rotation=r}getForward(){return new U(Math.sin(this.rotation),0,Math.cos(this.rotation))}isAttacking(){let e=this.fsm.current;return e===`attack1`||e===`attack2`||e===`attack3`||e===`stinger`||e===`highTime`||e===`aerial`}isDodging(){return this.fsm.current===`dodge`}getAttackRange(){switch(this.currentAttackType){case`stinger`:return 2.5;case`highTime`:return 1.8;case`aerial`:return 1.5;default:return 2}}getAttackDamage(){let e;switch(this.currentAttackType){case`sword1`:e=8;break;case`sword2`:e=10;break;case`sword3`:e=15;break;case`stinger`:e=18;break;case`highTime`:e=12;break;case`aerial`:e=7;break;case`gun`:e=3;break;default:e=5}return this.dtActive?e*this.dtDamageMultiplier:e}getAttackDirection(){return this.getForward()}fireGun(){this.currentAttackType=`gun`,this.game.audio.playSFX(`gunshot`);let e=this.getForward(),t=this.position.clone().add(new U(0,1.3,0)).clone().add(e.clone().multiplyScalar(.8));this.game.particles.spawnMuzzleFlash(t);let n=null,r=20;for(let t of this.game.enemyManager.enemies){if(t.dead)continue;let i=t.position.clone().sub(this.position),a=i.length();i.normalize(),e.dot(i)>.5&&a<r&&(r=a,n=t)}if(n){let r=this.getAttackDamage();n.takeDamage(r,e,`gun`),this.game.styleRank.onHit(`gun`),this.game.addRedOrbs(Math.floor(r)),this.game.particles.spawnHitSpark(n.position.clone().add(new U(0,1,0))),this.game.particles.spawnBulletTrail(t,n.position.clone().add(new U(0,1,0)))}if(n){let e=n.position.clone().sub(this.position);this.rotation=Math.atan2(e.x,e.z)}}takeDamage(e,t){this.invulnerable||this.fsm.current===`dead`||(this.hp-=e,this.game.audio.playSFX(`playerHit`),this.velocity.copy(t).multiplyScalar(-5),this.velocity.y=0,this.hp<=0?(this.hp=0,this.fsm.transition(`dead`),this.game.gameOver()):this.fsm.transition(`hit`))}activateDT(){this.dtActive=!0,this.game.audio.playSFX(`devilTrigger`),this.game.shake(.4,.3),this.torso.material=new Z({color:6684672,emissive:3342336}),this.game.particles.spawnDTActivation(this.position.clone().add(new U(0,1,0)))}deactivateDT(){this.dtActive=!1,this.dtAura.intensity=0,this.dtOverlay.material.opacity=0,this.torso.material=new Z({color:13369344})}updateMeshTransform(){this.mesh.position.copy(this.position),this.mesh.rotation.y=this.rotation}idleAnim(e){this.animTime+=e;let t=this.animTime;this.torso.position.y=1.3+Math.sin(t*2)*.02,this.coatTailL.rotation.x=Math.sin(t*1.5)*.05,this.coatTailR.rotation.x=Math.sin(t*1.5+.5)*.05,this.leftArm.rotation.x=0,this.rightArm.rotation.x=0,this.leftArm.rotation.z=.1,this.rightArm.rotation.z=-.1,this.leftLeg.rotation.x=0,this.rightLeg.rotation.x=0,this.sword.position.set(.1,1.2,-.25),this.sword.rotation.set(.3,0,.1)}moveAnim(e){this.animTime+=e;let t=this.animTime,n=Math.sin(t*8);this.leftLeg.rotation.x=n*.5,this.rightLeg.rotation.x=-n*.5,this.leftArm.rotation.x=-n*.3,this.rightArm.rotation.x=n*.3,this.leftArm.rotation.z=.1,this.rightArm.rotation.z=-.1,this.torso.position.y=1.3+Math.abs(Math.sin(t*8))*.04,this.coatTailL.rotation.x=n*.15,this.coatTailR.rotation.x=-n*.12}attackAnim(e,t){this.animTime+=e;let n=this.attackTimer/this.attackDuration;switch(this.sword.position.set(.4,1.5,.3),t){case 1:this.rightArm.rotation.x=-1.2+n*2.4,this.rightArm.rotation.z=-.5+n*1,this.sword.rotation.set(0,n*Math.PI,-.5+n*1),this.torso.rotation.y=-.3+n*.6;break;case 2:this.rightArm.rotation.x=1.2-n*2.4,this.rightArm.rotation.z=.5-n*1,this.sword.rotation.set(0,Math.PI-n*Math.PI,.5-n*1),this.torso.rotation.y=.3-n*.6;break;case 3:this.rightArm.rotation.x=-2+n*3.5,this.rightArm.rotation.z=0,this.sword.rotation.set(-2+n*3.5,0,0),this.torso.rotation.y=0,this.torso.position.y=1.3-n*.15;break}if(this.leftArm.rotation.x=-.3,this.leftArm.rotation.z=.3,n>.2&&n<.7){let e=new U;this.sword.getWorldPosition(e),e.y+=.7,this.game.particles.spawnSlashTrail(e,this.dtActive)}}stingerAnim(e){this.attackTimer/this.attackDuration,this.sword.position.set(.4,1.3,.5),this.rightArm.rotation.x=-1.5,this.rightArm.rotation.z=0,this.sword.rotation.set(-1.5,0,0),this.torso.rotation.y=0,this.leftArm.rotation.x=.5,this.leftLeg.rotation.x=-.5,this.rightLeg.rotation.x=.5}highTimeAnim(e){let t=this.attackTimer/this.attackDuration;this.sword.position.set(.4,1.5,.3),this.rightArm.rotation.x=1.5-t*3.5,this.sword.rotation.set(1.5-t*3.5,0,0),this.torso.position.y=1.3+t*.2}aerialAnim(e){this.animTime+=e;let t=Math.sin(this.animTime*12);this.sword.position.set(.4,1.5,.3),this.rightArm.rotation.x=t*1.5,this.sword.rotation.set(t*1.5,0,0),this.leftLeg.rotation.x=-.3,this.rightLeg.rotation.x=.3}shootAnim(e){this.animTime+=e,this.leftArm.rotation.x=-1.5,this.leftArm.rotation.z=.3,this.rightArm.rotation.x=-1.5,this.rightArm.rotation.z=-.3,this.gunL.position.set(-.5,1.55,.5),this.gunR.position.set(.5,1.55,.5);let t=Math.sin(this.animTime*30)*.03;this.gunL.position.z-=t,this.gunR.position.z+=t,this.sword.position.set(.1,1.2,-.25),this.sword.rotation.set(.3,0,.1)}dodgeAnim(e){this.animTime+=e;let t=1-this.dodgeTimer/.35;this.torso.rotation.x=Math.sin(t*Math.PI)*.8,this.torso.position.y=1.3-Math.sin(t*Math.PI)*.3,this.leftLeg.rotation.x=Math.sin(t*Math.PI)*.5,this.rightLeg.rotation.x=-Math.sin(t*Math.PI)*.3}jumpAnim(e){this.leftLeg.rotation.x=-.3,this.rightLeg.rotation.x=.2,this.leftArm.rotation.x=-.3,this.rightArm.rotation.x=-.3,this.coatTailL.rotation.x=.3,this.coatTailR.rotation.x=.3}hitAnim(e){let t=this.attackTimer/.3;this.torso.rotation.x=-.3*(1-t),this.torso.position.y=1.3-.1*(1-t)}deadAnim(e){if(this.animTime+=e,this.animTime<.5){let e=this.animTime/.5;this.mesh.rotation.x=e*Math.PI/2,this.mesh.position.y=Math.max(0,.5-e*.5)}}},Gc=0,Kc=class{constructor(e,t){this.game=e,this.id=++Gc,this.type=t,this.position=new U,this.velocity=new U,this.rotation=0,this.mesh=null,this.maxHP=30,this.hp=30,this.speed=2.5,this.radius=.6,this.attackRange=1.5,this.attackDamage=10,this.dead=!1,this.invulnerable=!1,this.hitStunTimer=0,this.deathTimer=0,this.attackTimer=0,this.attackCooldown=0,this.attackActive=!1,this.animTime=0,this.knockbackVel=new U,this.aiTimer=0,this.aiDecision=`idle`,this.strafeDir=1,this.circleAngle=0}isAttacking(){return this.attackActive}getAttackDirection(){return new U(Math.sin(this.rotation),0,Math.cos(this.rotation))}takeDamage(e,t,n){this.dead||this.invulnerable||(this.hp-=e,this.hitStunTimer=.3,this.attackActive=!1,this.knockbackVel.copy(t).multiplyScalar(4),(n===`sword3`||n===`stinger`)&&this.knockbackVel.multiplyScalar(2),n===`highTime`&&(this.knockbackVel.y=5),this.game.audio.playSFX(`swordHit`),this.hp<=0&&this.die())}die(){this.dead=!0,this.deathTimer=0,this.game.audio.playSFX(`enemyDeath`),this.game.particles.spawnDeathBurst(this.position.clone().add(new U(0,1,0))),this.game.addRedOrbs(20+Math.floor(Math.random()*30))}update(e){return this.dead?(this.deathTimer+=e,this.deathAnim(e),this.deathTimer>1.5):this.hitStunTimer>0?(this.hitStunTimer-=e,this.knockbackVel.x*=.9,this.knockbackVel.z*=.9,this.knockbackVel.y!==0&&(this.knockbackVel.y-=20*e),this.position.add(this.knockbackVel.clone().multiplyScalar(e)),this.position.y<0&&(this.position.y=0,this.knockbackVel.y=0),this.hitAnim(e),this.updateMeshTransform(),!1):(this.attackCooldown>0&&(this.attackCooldown-=e),this.updateAI(e),this.updateMeshTransform(),!1)}updateAI(e){}updateMeshTransform(){this.mesh&&(this.mesh.position.copy(this.position),this.mesh.rotation.y=this.rotation)}facePlayer(){let e=this.game.player.position.clone().sub(this.position);this.rotation=Math.atan2(e.x,e.z)}distToPlayer(){return this.position.distanceTo(this.game.player.position)}hitAnim(e){}deathAnim(e){}idleAnim(e){}walkAnim(e){}attackAnim(e){}},qc=class extends Kc{constructor(e){super(e,`marionette`),this.maxHP=40,this.hp=40,this.speed=3,this.attackDamage=8,this.attackRange=1.8,this.buildModel()}buildModel(){this.mesh=new K;let e=new Z({color:9136404}),t=new Z({color:4864522}),n=new yr({color:16711680});this.torso=new Y(new X(.45,.7,.25),e),this.torso.position.y=1.2,this.torso.castShadow=!0,this.mesh.add(this.torso),this.headGroup=new K,this.headGroup.position.y=1.75;let r=new Y(new X(.3,.3,.25),e);this.headGroup.add(r);let i=new Y(new li(.04,4,4),n);i.position.set(-.08,.05,.13),this.headGroup.add(i);let a=new Y(new li(.04,4,4),n);a.position.set(.08,.05,.13),this.headGroup.add(a),this.mesh.add(this.headGroup),this.leftArm=new K,this.leftArm.position.set(-.3,1.45,0);let o=new Y(new X(.1,.6,.1),t);o.position.y=-.3,this.leftArm.add(o);let s=new Y(new X(.04,.25,.04),new Z({color:11184810}));s.position.y=-.65,this.leftArm.add(s),this.mesh.add(this.leftArm),this.rightArm=new K,this.rightArm.position.set(.3,1.45,0);let c=new Y(new X(.1,.6,.1),t);c.position.y=-.3,this.rightArm.add(c);let l=new Y(new X(.04,.25,.04),new Z({color:11184810}));l.position.y=-.65,this.rightArm.add(l),this.mesh.add(this.rightArm),this.leftLeg=new K,this.leftLeg.position.set(-.12,.85,0);let u=new Y(new X(.12,.6,.12),t);u.position.y=-.3,this.leftLeg.add(u),this.mesh.add(this.leftLeg),this.rightLeg=new K,this.rightLeg.position.set(.12,.85,0);let d=new Y(new X(.12,.6,.12),t);d.position.y=-.3,this.rightLeg.add(d),this.mesh.add(this.rightLeg);let f=new yr({color:8947848});for(let e=-1;e<=1;e+=2){let t=new Y(new ai(.005,.005,1.5,4),f);t.position.set(e*.15,2.5,0),this.mesh.add(t)}this.hpBarBg=new Y(new si(.8,.08),new yr({color:3355443})),this.hpBarBg.position.set(0,2.3,0),this.hpBarBg.lookAt(0,2.3,1),this.mesh.add(this.hpBarBg),this.hpBar=new Y(new si(.78,.06),new yr({color:16711680})),this.hpBar.position.set(0,2.3,.001),this.hpBar.lookAt(0,2.3,1),this.mesh.add(this.hpBar)}updateAI(e){this.animTime+=e;let t=this.distToPlayer();this.facePlayer();let n=this.hp/this.maxHP;if(this.hpBar.scale.x=Math.max(.01,n),this.hpBar.position.x=-(1-n)*.39,this.game.camera&&(this.hpBarBg.quaternion.copy(this.game.camera.camera.quaternion),this.hpBar.quaternion.copy(this.game.camera.camera.quaternion)),this.attackActive){this.attackTimer+=e,this.attackAnim(e),this.attackTimer>.4&&(this.attackActive=!1,this.attackCooldown=1+Math.random()*.5);return}switch(this.aiTimer-=e,this.aiTimer<=0&&(this.aiTimer=.5+Math.random()*.5,t<this.attackRange&&this.attackCooldown<=0?this.aiDecision=`attack`:t<8?(this.aiDecision=Math.random()<.7?`chase`:`strafe`,this.strafeDir=Math.random()<.5?1:-1):this.aiDecision=`idle`),this.aiDecision){case`chase`:{let t=this.game.player.position.clone().sub(this.position).normalize();this.position.x+=t.x*this.speed*e,this.position.z+=t.z*this.speed*e,this.walkAnim(e);break}case`strafe`:{let t=this.game.player.position.clone().sub(this.position),n=new U(-t.z,0,t.x).normalize();this.position.x+=n.x*this.speed*.6*this.strafeDir*e,this.position.z+=n.z*this.speed*.6*this.strafeDir*e,t.normalize(),this.position.x+=t.x*this.speed*.3*e,this.position.z+=t.z*this.speed*.3*e,this.walkAnim(e);break}case`attack`:this.attackActive=!0,this.attackTimer=0;break;default:this.idleAnim(e)}let r=this.game.level.getBounds();this.position.x=Math.max(r.minX+.5,Math.min(r.maxX-.5,this.position.x)),this.position.z=Math.max(r.minZ+.5,Math.min(r.maxZ-.5,this.position.z))}idleAnim(e){let t=this.animTime;this.torso.position.y=1.2+Math.sin(t*3)*.03,this.headGroup.rotation.z=Math.sin(t*2)*.1,this.leftArm.rotation.x=Math.sin(t*1.5)*.2,this.rightArm.rotation.x=Math.sin(t*1.5+1)*.2,this.leftArm.rotation.z=-.4,this.rightArm.rotation.z=.4}walkAnim(e){let t=this.animTime,n=Math.sin(t*6);this.leftLeg.rotation.x=n*.4,this.rightLeg.rotation.x=-n*.4,this.leftArm.rotation.x=-n*.3-.3,this.rightArm.rotation.x=n*.3-.3,this.leftArm.rotation.z=-.4,this.rightArm.rotation.z=.4,this.headGroup.rotation.z=Math.sin(t*8)*.15,this.torso.position.y=1.2+Math.abs(n)*.03}attackAnim(e){let t=this.attackTimer/.4;this.leftArm.rotation.x=-2+t*3,this.rightArm.rotation.x=-2+t*3,this.leftArm.rotation.z=-.3+t*.6,this.rightArm.rotation.z=.3-t*.6,this.torso.rotation.x=-.2+t*.4}hitAnim(e){this.torso.rotation.x=-.3,this.headGroup.rotation.z=.3}deathAnim(e){let t=Math.min(1,this.deathTimer/1);this.mesh.rotation.z=t*Math.PI*.4,this.mesh.position.y=-t*.5,this.mesh.scale.setScalar(1-t*.5),this.mesh.traverse(e=>{e.isMesh&&e.material&&(e.material.transparent=!0,e.material.opacity=1-t)})}},Jc=class extends Kc{constructor(e){super(e,`phantom`),this.maxHP=300,this.hp=300,this.speed=2,this.radius=2,this.attackRange=3,this.attackDamage=20,this.phase=0,this.patternTimer=0,this.chargeSpeed=12,this.chargeDir=new U,this.fireballCooldown=0,this.buildModel()}buildModel(){this.mesh=new K;let e=new Z({color:9118976,emissive:3346432}),t=new Z({color:6035968,emissive:1705984}),n=new yr({color:16729088}),r=new yr({color:16737792,transparent:!0,opacity:.7}),i=new Y(new li(1.2,8,6),e);i.scale.set(1,.6,1.3),i.position.y=1.2,i.castShadow=!0,this.mesh.add(i),this.body=i;let a=new Y(new li(1.3,8,4),t);a.scale.set(1,.4,1.2),a.position.y=1.5,a.castShadow=!0,this.mesh.add(a);let o=new K;o.position.set(0,1.2,1.3);let s=new Y(new X(.8,.5,.6),e);o.add(s);for(let e=-1;e<=1;e++){let t=new Y(new li(.08,6,6),n);t.position.set(e*.2,.1,.3),o.add(t)}let c=new Y(new X(.1,.1,.3),t);c.position.set(-.3,-.15,.3),c.rotation.y=.3,o.add(c);let l=new Y(new X(.1,.1,.3),t);l.position.set(.3,-.15,.3),l.rotation.y=-.3,o.add(l),this.mesh.add(o),this.headGroup=o,this.legs=[];for(let n=-1;n<=1;n+=2)for(let r=0;r<4;r++){let i=new K,a=(r/3-.5)*Math.PI*.6;i.position.set(n*.8,1,Math.sin(a)*.8);let o=new Y(new X(.12,.8,.12),t);o.position.set(n*.3,.1,0),o.rotation.z=n*-.8,i.add(o);let s=new Y(new X(.08,.9,.08),e);s.position.set(n*.7,-.3,0),s.rotation.z=n*.3,i.add(s),this.mesh.add(i),this.legs.push(i)}this.fireLight=new $i(16729088,2,8),this.fireLight.position.y=1.5,this.mesh.add(this.fireLight);let u=new Y(new oi(.3,1.5,6),r);u.position.set(0,1.5,-1.5),u.rotation.x=Math.PI*.3,this.mesh.add(u),this.tail=u,this.hpBarBg=new Y(new si(2.5,.12),new yr({color:3355443})),this.hpBarBg.position.set(0,3,0),this.mesh.add(this.hpBarBg),this.hpBar=new Y(new si(2.45,.1),new yr({color:16729088})),this.hpBar.position.set(0,3,.001),this.mesh.add(this.hpBar),this.mesh.scale.setScalar(1.3)}updateAI(e){this.animTime+=e;let t=this.distToPlayer(),n=this.hp/this.maxHP;if(this.hpBar.scale.x=Math.max(.01,n),this.hpBar.position.x=-(1-n)*1.225,this.game.camera&&(this.hpBarBg.quaternion.copy(this.game.camera.camera.quaternion),this.hpBar.quaternion.copy(this.game.camera.camera.quaternion)),this.fireLight.intensity=2+Math.sin(this.animTime*8)*.5,this.tail.material.opacity=.5+Math.sin(this.animTime*6)*.2,this.tail.rotation.z=Math.sin(this.animTime*3)*.2,Math.random()<.3){let e=this.position.clone().add(new U((Math.random()-.5)*2,1.5+Math.random(),(Math.random()-.5)*2));this.game.particles.spawnFireParticle(e)}for(let e=0;e<this.legs.length;e++)this.legs[e].rotation.x=Math.sin(this.animTime*4+e*.8)*.2;if(this.attackActive){this.attackTimer+=e,this.performAttack(e);return}if(this.facePlayer(),this.patternTimer-=e,this.patternTimer<=0){this.patternTimer=2+Math.random()*1.5;let n=this.hp/this.maxHP;if(t<4&&Math.random()<.5)this.phase=2,this.attackActive=!0,this.attackTimer=0;else if(t>5&&Math.random()<.6)this.phase=1,this.attackActive=!0,this.attackTimer=0;else if(Math.random()<.7)this.phase=0,this.attackActive=!0,this.attackTimer=0,this.chargeDir.copy(this.game.player.position).sub(this.position).normalize();else{let t=this.game.player.position.clone().sub(this.position).normalize();this.position.x+=t.x*this.speed*e,this.position.z+=t.z*this.speed*e}n<.3&&(this.patternTimer*=.6,this.attackDamage=25)}else if(t>4){let t=this.game.player.position.clone().sub(this.position).normalize();this.position.x+=t.x*this.speed*e,this.position.z+=t.z*this.speed*e}let r=this.game.level.getBounds();this.position.x=Math.max(r.minX+1.5,Math.min(r.maxX-1.5,this.position.x)),this.position.z=Math.max(r.minZ+1.5,Math.min(r.maxZ-1.5,this.position.z))}performAttack(e){switch(this.phase){case 0:this.attackTimer<.5?this.body.position.y=1.2-this.attackTimer*.3:this.attackTimer<1.2&&(this.position.x+=this.chargeDir.x*this.chargeSpeed*e,this.position.z+=this.chargeDir.z*this.chargeSpeed*e,this.attackRange=2.5,this.distToPlayer()<2.5&&(this.attackActive=!0)),this.attackTimer>1.2&&(this.attackActive=!1,this.attackCooldown=1,this.body.position.y=1.2);break;case 1:if(this.attackTimer>.3&&this.attackTimer<.4){this.fireballCooldown=999;let e=this.game.player.position.clone().sub(this.position).normalize();this.game.particles.spawnFireball(this.position.clone().add(new U(0,1.2,0)).add(e.clone().multiplyScalar(1.5)),e,this.game)}this.attackTimer>.8&&(this.attackActive=!1);break;case 2:this.attackTimer<.4?this.mesh.position.y=this.attackTimer*5:this.attackTimer<.6?this.mesh.position.y=Math.max(0,2-(this.attackTimer-.4)*15):this.attackTimer<.7&&this.attackTimer-e<.6&&(this.game.shake(.5,.3),this.attackRange=4,this.attackDamage=25,this.game.particles.spawnGroundSlam(this.position.clone())),this.attackTimer>1&&(this.attackActive=!1,this.mesh.position.y=0,this.attackRange=3,this.attackDamage=20);break}}hitAnim(e){this.body.position.y=1.3,this.mesh.rotation.z=Math.sin(this.animTime*20)*.05}deathAnim(e){let t=Math.min(1,this.deathTimer/1.5);if(this.mesh.rotation.z=Math.sin(t*20)*.1*(1-t),this.mesh.position.y=-t*1,this.mesh.scale.setScalar(1.3*(1-t*.5)),this.fireLight.intensity=2*(1-t),Math.random()<.5){let e=this.position.clone().add(new U((Math.random()-.5)*3,Math.random()*2,(Math.random()-.5)*3));this.game.particles.spawnFireParticle(e)}}},Yc=class{constructor(e){this.game=e,this.enemies=[],this.waveSpawned=!1}spawnWave(e){this.clearAll();let t=[()=>{this.spawnMarionettes(3)},()=>{this.spawnMarionettes(5)},()=>{this.spawnMarionettes(4)},()=>{this.spawnMarionettes(6)},()=>{this.spawnBoss(),this.spawnMarionettes(2)}];t[Math.min(e,t.length-1)](),this.waveSpawned=!0}spawnMarionettes(e){for(let t=0;t<e;t++){let n=new qc(this.game),r=t/e*Math.PI*2,i=4+Math.random()*3;n.position.set(Math.sin(r)*i,0,Math.cos(r)*i),n.rotation=r+Math.PI,this.enemies.push(n),this.game.scene.add(n.mesh)}}spawnBoss(){let e=new Jc(this.game);e.position.set(0,0,-5),this.enemies.push(e),this.game.scene.add(e.mesh)}update(e){for(let t=this.enemies.length-1;t>=0;t--)this.enemies[t].update(e)&&(this.game.scene.remove(this.enemies[t].mesh),this.enemies.splice(t,1))}allDead(){return this.enemies.length===0}clearAll(){for(let e of this.enemies)this.game.scene.remove(e.mesh);this.enemies=[],this.waveSpawned=!1}},Xc=class{constructor(e){this.game=e,this.roomGroup=null,this.bounds={minX:-8,maxX:8,minZ:-8,maxZ:8},this.door=null,this.doorOpen=!1,this.doorLight=null,this.torchLights=[]}getBounds(){return this.bounds}buildRoom(e){this.roomGroup&&this.game.scene.remove(this.roomGroup),this.roomGroup=new K,this.doorOpen=!1,this.torchLights=[];let t=[()=>this.buildEntranceHall(),()=>this.buildCorridorRoom(),()=>this.buildCathedralRoom(),()=>this.buildDungeonRoom(),()=>this.buildBossArena()];t[Math.min(e,t.length-1)]();let n=new ra(16777215,2);this.roomGroup.add(n);let r=new zi(11184844,4473924,1.5);this.roomGroup.add(r);let i=new na(16772829,3);i.position.set(5,10,5),this.roomGroup.add(i);let a=new na(13426175,1.5);a.position.set(-5,8,-5),this.roomGroup.add(a),this.game.scene.add(this.roomGroup)}buildEntranceHall(){this.bounds={minX:-8,maxX:8,minZ:-8,maxZ:8},this.buildFloor(16,16,4868682),this.buildWalls(16,16,5,5917242);for(let e=-1;e<=1;e+=2)for(let t=-1;t<=1;t+=2)this.addPillar(e*4,t*4,5,6969930);this.addTorch(-7.5,2.5,-7.5),this.addTorch(7.5,2.5,-7.5),this.addTorch(-7.5,2.5,7.5),this.addTorch(7.5,2.5,7.5);let e=new $i(16746564,4,25);e.position.set(0,4.5,0),e.castShadow=!0,e.shadow.mapSize.set(512,512),this.roomGroup.add(e);let t=new K,n=new Y(new ui(.5,.05,8,12),new Z({color:9075290}));n.rotation.x=Math.PI/2,t.add(n);let r=new Y(new ai(.02,.02,.5,4),new Z({color:6710886}));r.position.y=.25,t.add(r),t.position.set(0,4.5,0),this.roomGroup.add(t),this.addDoor(0,0,-7.9),this.addArch(-3,0,-7.9,0),this.addArch(3,0,-7.9,0)}buildCorridorRoom(){this.bounds={minX:-5,maxX:5,minZ:-12,maxZ:12},this.buildFloor(10,24,4473924),this.buildWalls(10,24,5,5588288);for(let e=-10;e<=10;e+=5)this.addPillar(-4,e,5,3811866),this.addPillar(4,e,5,3811866);for(let e=-10;e<=10;e+=5)this.addTorch(-4.8,2.5,e),this.addTorch(4.8,2.5,e);this.addDoor(0,0,-11.9)}buildCathedralRoom(){this.bounds={minX:-10,maxX:10,minZ:-10,maxZ:10},this.buildFloor(20,20,3816010),this.buildWalls(20,20,8,4868698);for(let e=-1;e<=1;e+=2)for(let t=-2;t<=2;t++)this.addPillar(e*6,t*3,8,3816010);let e=[16711680,255,65280,16776960];for(let t=0;t<4;t++){let n=new $i(e[t],.5,8),r=t/4*Math.PI*2;n.position.set(Math.sin(r)*9,5,Math.cos(r)*9),this.roomGroup.add(n);let i=new Y(new si(2,3),new yr({color:e[t],transparent:!0,opacity:.3,side:2}));i.position.copy(n.position),i.lookAt(0,5,0),this.roomGroup.add(i)}let t=new Y(new X(2,1,1),new Z({color:4473924}));t.position.set(0,.5,-6),t.castShadow=!0,t.receiveShadow=!0,this.roomGroup.add(t),this.addTorch(-9.5,3,-9.5),this.addTorch(9.5,3,-9.5),this.addTorch(-9.5,3,9.5),this.addTorch(9.5,3,9.5),this.addTorch(0,4,-9.5),this.addDoor(0,0,-9.9)}buildDungeonRoom(){this.bounds={minX:-7,maxX:7,minZ:-7,maxZ:7},this.buildFloor(14,14,3815994),this.buildWalls(14,14,4,4864570);for(let e=-1;e<=1;e+=2){let t=new K;for(let e=-2;e<=2;e++){let n=new Y(new ai(.03,.03,3,4),new Z({color:5592405}));n.position.set(e*.3,1.5,0),t.add(n)}let n=new Y(new X(1.4,.06,.06),new Z({color:5592405}));n.position.y=3,t.add(n),t.position.set(e*5.5,0,-4),this.roomGroup.add(t)}for(let e=0;e<5;e++){let e=new Y(new ai(.02,.02,2+Math.random(),4),new Z({color:6710886}));e.position.set((Math.random()-.5)*10,3+Math.random(),(Math.random()-.5)*10),this.roomGroup.add(e)}let e=new $i(16720384,4,20);e.position.set(0,3,0),this.roomGroup.add(e),this.addTorch(-6.5,2,-6.5),this.addTorch(6.5,2,-6.5),this.addTorch(-6.5,2,6.5),this.addTorch(6.5,2,6.5),this.addDoor(0,0,-6.9)}buildBossArena(){this.bounds={minX:-12,maxX:12,minZ:-12,maxZ:12},this.buildFloor(24,24,3811882),this.buildWalls(24,24,7,5913130);for(let e=0;e<8;e++){let e=new Y(new si(.15,4+Math.random()*6),new yr({color:16729088,transparent:!0,opacity:.6}));e.rotation.x=-Math.PI/2,e.rotation.z=Math.random()*Math.PI,e.position.set((Math.random()-.5)*18,.01,(Math.random()-.5)*18),this.roomGroup.add(e)}for(let e=0;e<8;e++){let t=e/8*Math.PI*2,n=e%3==0?3:7;this.addPillar(Math.sin(t)*9,Math.cos(t)*9,n,4860442)}for(let e=0;e<4;e++){let t=e/4*Math.PI*2+Math.PI/4,n=Math.sin(t)*10,r=Math.cos(t)*10;this.addBrazier(n,r)}let e=new Y(new ci(3,3.2,32),new yr({color:8912896,side:2}));e.rotation.x=-Math.PI/2,e.position.y=.01,this.roomGroup.add(e);let t=new cr,n=[];for(let e=0;e<5;e++){let t=e*2%5/5*Math.PI*2-Math.PI/2,r=(e*2+2)%5/5*Math.PI*2-Math.PI/2;n.push(Math.cos(t)*2.8,.02,Math.sin(t)*2.8),n.push(Math.cos(r)*2.8,.02,Math.sin(r)*2.8)}t.setAttribute(`position`,new J(n,3));let r=new ei(t,new Hr({color:16711680}));this.roomGroup.add(r);let i=new $i(16729088,5,30);i.position.set(0,6,0),i.castShadow=!0,this.roomGroup.add(i),this.door=null}buildFloor(e,t,n){let r=new Y(new si(e,t,e,t),new Z({color:n}));r.rotation.x=-Math.PI/2,r.receiveShadow=!0,this.roomGroup.add(r);let i=new xa(Math.max(e,t),Math.max(e,t),3355443,2236962);i.position.y=.01,this.roomGroup.add(i)}buildWalls(e,t,n,r){let i=new Z({color:r,side:2}),a=e/2,o=t/2,s=new Y(new si(e,n),i);s.position.set(0,n/2,-o),s.receiveShadow=!0,this.roomGroup.add(s);let c=new Y(new si(e,n),i);c.position.set(0,n/2,o),c.rotation.y=Math.PI,c.receiveShadow=!0,this.roomGroup.add(c);let l=new Y(new si(t,n),i);l.position.set(a,n/2,0),l.rotation.y=-Math.PI/2,l.receiveShadow=!0,this.roomGroup.add(l);let u=new Y(new si(t,n),i);u.position.set(-a,n/2,0),u.rotation.y=Math.PI/2,u.receiveShadow=!0,this.roomGroup.add(u);let d=new Y(new si(e,t),new Z({color:3355443,side:2}));d.rotation.x=Math.PI/2,d.position.y=n,this.roomGroup.add(d)}addPillar(e,t,n,r){let i=new Y(new ai(.4,.5,n,8),new Z({color:r}));i.position.set(e,n/2,t),i.castShadow=!0,i.receiveShadow=!0,this.roomGroup.add(i);let a=new Y(new ai(.6,.7,.3,8),new Z({color:r}));a.position.set(e,.15,t),this.roomGroup.add(a);let o=new Y(new ai(.6,.4,.3,8),new Z({color:r}));o.position.set(e,n-.15,t),this.roomGroup.add(o)}addTorch(e,t,n){let r=new K,i=new Y(new X(.1,.4,.1),new Z({color:4864554}));r.add(i);let a=new Y(new ai(.08,.05,.15,6),new Z({color:4864554}));a.position.y=.25,r.add(a);let o=new Y(new li(.08,6,6),new yr({color:16746564}));o.position.y=.35,r.add(o);let s=new $i(16737843,3,15);s.position.y=.35,s.castShadow=!1,r.add(s),this.torchLights.push({light:s,baseIntensity:3}),r.position.set(e,t,n),this.roomGroup.add(r)}addBrazier(e,t){let n=new K,r=new Y(new ai(.5,.3,.4,8),new Z({color:5592405}));r.position.y=1,n.add(r);let i=new Y(new ai(.15,.25,1,6),new Z({color:4473924}));i.position.y=.5,n.add(i);let a=new $i(16729088,5,15);a.position.y=1.5,n.add(a),this.torchLights.push({light:a,baseIntensity:5}),n.position.set(e,0,t),this.roomGroup.add(n)}addArch(e,t,n,r){let i=new Z({color:4864554}),a=new K,o=new Y(new X(.3,3,.3),i);o.position.set(-.8,1.5,0),a.add(o);let s=new Y(new X(.3,3,.3),i);s.position.set(.8,1.5,0),a.add(s);let c=new Y(new X(1.9,.3,.3),i);c.position.y=3,a.add(c),a.position.set(e,t,n),a.rotation.y=r,this.roomGroup.add(a)}addDoor(e,t,n){this.door=new K;let r=new Z({color:5917242}),i=new Y(new X(.2,3.5,.3),r);i.position.set(-1,1.75,0),this.door.add(i);let a=new Y(new X(.2,3.5,.3),r);a.position.set(1,1.75,0),this.door.add(a);let o=new Y(new X(2.2,.2,.3),r);o.position.set(0,3.5,0),this.door.add(o),this.doorPanelL=new Y(new X(.9,3.3,.15),new Z({color:3811866})),this.doorPanelL.position.set(-.45,1.65,0),this.door.add(this.doorPanelL),this.doorPanelR=new Y(new X(.9,3.3,.15),new Z({color:3811866})),this.doorPanelR.position.set(.45,1.65,0),this.door.add(this.doorPanelR),this.doorLight=new $i(16711680,1,3),this.doorLight.position.set(0,2,.3),this.door.add(this.doorLight);let s=new Y(new li(.08,6,6),new yr({color:16711680}));s.position.set(0,2,.15),this.door.add(s),this.lockGem=s,this.door.position.set(e,t,n),this.roomGroup.add(this.door)}openDoor(){!this.door||this.doorOpen||(this.doorOpen=!0,this.game.audio.playSFX(`doorOpen`),this.doorLight.color.setHex(65280),this.lockGem.material.color.setHex(65280),(()=>{let e=0,t=setInterval(()=>{if(e+=.02,e>=1){clearInterval(t),this.createDoorTrigger();return}this.doorPanelL.position.x=-.45-e*.8,this.doorPanelR.position.x=.45+e*.8},16)})())}createDoorTrigger(){let e=()=>{if(!this.doorOpen||this.game.state!==`playing`)return;let t=this.game.player.position,n=this.door.position;if(Math.sqrt((t.x-n.x)**2+(t.z-n.z)**2)<2){this.game.nextRoom();return}requestAnimationFrame(e)};e()}},Zc=class{constructor(e){this.game=e,this.container=null,this.elements={},this.styleFlashTimer=0,this.orbFlashTimer=0}init(){this.container=document.createElement(`div`),this.container.id=`hud`,this.container.style.cssText=`
      position: fixed; top: 0; left: 0; width: 100%; height: 100%;
      pointer-events: none; z-index: 15; display: none;
      font-family: 'Segoe UI', Arial, sans-serif;
    `,document.getElementById(`ui-overlay`).appendChild(this.container),this.createHPBar(),this.createDTBar(),this.createStyleMeter(),this.createOrbCounter(),this.createRoomIndicator()}createHPBar(){let e=document.createElement(`div`);e.style.cssText=`
      position: absolute; top: 15px; left: 15px;
    `;let t=document.createElement(`div`);t.style.cssText=`font-size: 10px; color: #888; margin-bottom: 2px; letter-spacing: 2px;`,t.textContent=`VITALITY`,e.appendChild(t);let n=document.createElement(`div`);n.style.cssText=`
    ...
    `,n.appendChild(r),e.appendChild(n),this.elements.hpBar=r,this.container.appendChild(e)}createDTBar(){let e=document.createElement(`div`);e.style.cssText=`
      position: absolute; top: 48px; left: 15px;
    `;let t=document.createElement(`div`);t.style.cssText=`font-size: 10px; color: #888; margin-bottom: 2px; letter-spacing: 2px;`,t.textContent=`DEVIL TRIGGER`,e.appendChild(t);let n=document.createElement(`div`);n.style.cssText=`
    ...
    `,n.appendChild(r),e.appendChild(n),this.elements.dtBar=r,this.container.appendChild(e)}createStyleMeter(){let e=document.createElement(`div`);e.style.cssText=`
    ...
    `;let t=document.createElement(`div`);t.style.cssText=`
      ...
      line-height: 1;
    `,t.textContent=`D`,e.appendChild(t),this.elements.styleRank=t;let n=document.createElement(`div`);n.style.cssText=`
      font-size: 14px; color: #888;
      margin-top: -5px; letter-spacing: 1px;
    `,n.textContent=``,e.appendChild(n),this.elements.comboCounter=n;let r=document.createElement(`div`);r.style.cssText=`font-size: 10px; color: #555; letter-spacing: 3px; margin-top: 2px;`,r.textContent=`STYLE`,e.appendChild(r),this.container.appendChild(e)}createOrbCounter(){let e=document.createElement(`div`);e.style.cssText=`
    ...
    `,e.appendChild(t);let n=document.createElement(`div`);n.style.cssText=`font-size: 16px; color: #ff4444; font-weight: bold;`,n.textContent=`0`,e.appendChild(n),this.elements.orbCount=n,this.container.appendChild(e)}createRoomIndicator(){let e=document.createElement(`div`);e.style.cssText=`
    ...
    `,this.elements.roomIndicator=e,this.container.appendChild(e)}update(e){let t=this.game.player,n=this.game.styleRank,r=t.hp/t.maxHP*100;this.elements.hpBar.style.width=`${r}%`,r<30?this.elements.hpBar.style.background=`linear-gradient(180deg, #ff4444, #882222)`:this.elements.hpBar.style.background=`linear-gradient(180deg, #44ff44, #228822)`;let i=t.dtGauge/t.maxDT*100;if(this.elements.dtBar.style.width=`${i}%`,t.dtActive?(this.elements.dtBar.style.background=`linear-gradient(180deg, #ff8844, #ff2200)`,this.elements.dtBar.style.boxShadow=`0 0 10px #ff4400`):(this.elements.dtBar.style.background=`linear-gradient(180deg, #ff4444, #880000)`,this.elements.dtBar.style.boxShadow=`none`),this.elements.styleRank.textContent=n.getRankText(),this.elements.styleRank.style.color=n.getRankColor(),this.elements.styleRank.style.textShadow=`0 0 15px ${n.getRankColor()}`,this.styleFlashTimer>0){this.styleFlashTimer-=e;let t=1+this.styleFlashTimer*2;this.elements.styleRank.style.transform=`scale(${t})`}else this.elements.styleRank.style.transform=`scale(1)`;let a=n.getComboCount();a>1?this.elements.comboCounter.textContent=`${a} HITS`:this.elements.comboCounter.textContent=``,this.elements.orbCount.textContent=this.game.redOrbs,this.orbFlashTimer>0?(this.orbFlashTimer-=e,this.elements.orbCount.style.color=`#ffff44`):this.elements.orbCount.style.color=`#ff4444`}flashStyle(){this.styleFlashTimer=.3}flashOrbs(){this.orbFlashTimer=.3}showRoomName(e){this.elements.roomIndicator.textContent=e,this.elements.roomIndicator.style.opacity=`1`,setTimeout(()=>{this.elements.roomIndicator.style.opacity=`0`},2e3)}show(){this.container.style.display=`block`}hide(){this.container.style.display=`none`}},Qc=class{constructor(e){this.game=e,this.container=null,this.joystickActive=!1,this.joystickId=null,this.joystickOrigin={x:0,y:0},this.buttons={},this.visible=!1}init(){this.container=document.createElement(`div`),this.container.id=`touch-controls`,this.container.style.cssText=`
      position: fixed; top: 0; left: 0; width: 100%; height: 100%;
      pointer-events: none; z-index: 20; display: none;
    `,document.getElementById(`ui-overlay`).appendChild(this.container),this.createJoystick(),this.createButtons()}createJoystick(){let e=document.createElement(`div`);e.style.cssText=`
    ...
    `,this.joystickBase=t,e.appendChild(t);let n=document.createElement(`div`);n.style.cssText=`
      ...
      transform: translate(-50%, -50%);
      transition: none;
    `,t.appendChild(n),this.joystickKnob=n,e.addEventListener(`touchstart`,e=>this.onJoystickStart(e),{passive:!1}),e.addEventListener(`touchmove`,e=>this.onJoystickMove(e),{passive:!1}),e.addEventListener(`touchend`,e=>this.onJoystickEnd(e),{passive:!1}),e.addEventListener(`touchcancel`,e=>this.onJoystickEnd(e),{passive:!1}),this.container.appendChild(e)}createButtons(){let e=document.createElement(`div`);e.style.cssText=`
      position: absolute; right: 0; top: 0; width: 45%; height: 100%;
      pointer-events: auto; touch-action: none;
    `;for(let t of[{id:`attack`,label:`SWORD`,x:-90,y:-80,color:`#cc0000`,size:60},{id:`shoot`,label:`GUN`,x:-155,y:-140,color:`#4488ff`,size:52},{id:`jump`,label:`JUMP`,x:-30,y:-150,color:`#44cc44`,size:55},{id:`dodge`,label:`DODGE`,x:-160,y:-55,color:`#cccc00`,size:50},{id:`devilTrigger`,label:`DT`,x:-75,y:-210,color:`#ff4400`,size:45}]){let n=document.createElement(`div`);n.style.cssText=`
        position: absolute;
        right: ${-t.x}px; bottom: ${-t.y}px;
        width: ${t.size}px; height: ${t.size}px;
        border-radius: 50%;
        background: rgba(${this.hexToRgb(t.color)}, 0.25);
        border: 2px solid ${t.color};
        display: flex; align-items: center; justify-content: center;
        font-size: 10px; color: ${t.color}; font-weight: bold;
        letter-spacing: 1px;
        user-select: none; touch-action: none;
        pointer-events: auto;
      `,n.textContent=t.label,n.dataset.action=t.id,n.addEventListener(`touchstart`,e=>{e.preventDefault(),this.onButtonDown(t.id),n.style.background=`rgba(${this.hexToRgb(t.color)}, 0.6)`,n.style.transform=`scale(0.9)`},{passive:!1}),n.addEventListener(`touchend`,e=>{e.preventDefault(),this.onButtonUp(t.id),n.style.background=`rgba(${this.hexToRgb(t.color)}, 0.25)`,n.style.transform=`scale(1)`},{passive:!1}),n.addEventListener(`touchcancel`,e=>{this.onButtonUp(t.id),n.style.background=`rgba(${this.hexToRgb(t.color)}, 0.25)`,n.style.transform=`scale(1)`}),e.appendChild(n),this.buttons[t.id]=n}let t=document.createElement(`div`);t.style.cssText=`
    ...
    `,t.textContent=`||`,t.addEventListener(`touchstart`,e=>{e.preventDefault(),this.game.state===`playing`&&this.game.pause()},{passive:!1}),e.appendChild(t),this.container.appendChild(e)}hexToRgb(e){return`${parseInt(e.slice(1,3),16)},${parseInt(e.slice(3,5),16)},${parseInt(e.slice(5,7),16)}`}onJoystickStart(e){if(e.preventDefault(),this.joystickActive)return;let t=e.changedTouches[0];this.joystickActive=!0,this.joystickId=t.identifier;let n=this.joystickBase.getBoundingClientRect();this.joystickOrigin.x=n.left+n.width/2,this.joystickOrigin.y=n.top+n.height/2,this.updateJoystick(t.clientX,t.clientY)}onJoystickMove(e){e.preventDefault();for(let t of e.changedTouches)t.identifier===this.joystickId&&this.updateJoystick(t.clientX,t.clientY)}onJoystickEnd(e){for(let t of e.changedTouches)t.identifier===this.joystickId&&(this.joystickActive=!1,this.joystickId=null,this.game.input.moveX=0,this.game.input.moveY=0,this.joystickKnob.style.transform=`translate(-50%, -50%)`)}updateJoystick(e,t){let n=e-this.joystickOrigin.x,r=t-this.joystickOrigin.y,i=Math.sqrt(n*n+r*r),a=Math.min(i,50),o=Math.atan2(r,n),s=Math.cos(o)*a,c=Math.sin(o)*a;this.joystickKnob.style.transform=`translate(calc(-50% + ${s}px), calc(-50% + ${c}px))`,this.game.input.moveX=s/50,this.game.input.moveY=c/50}onButtonDown(e){let t=this.game.input;switch(e){case`attack`:t.attack=!0;break;case`shoot`:t.shoot=!0;break;case`jump`:t.jump=!0;break;case`dodge`:t.dodge=!0;break;case`devilTrigger`:t.devilTrigger=!0;break}}onButtonUp(e){let t=this.game.input;switch(e){case`attack`:t.attack=!1;break;case`shoot`:t.shoot=!1;break;case`jump`:t.jump=!1;break;case`dodge`:t.dodge=!1;break;case`devilTrigger`:t.devilTrigger=!1;break}}show(){this.container.style.display=`block`,this.visible=!0}hide(){this.container.style.display=`none`,this.visible=!1}},$c=class{constructor(e){this.game=e,this.container=null,this.currentScreen=null}show(){this.showMain()}hide(){this.container&&(this.container.style.display=`none`)}createContainer(){return this.container&&this.container.remove(),this.container=document.createElement(`div`),this.container.style.cssText=`
      position: fixed; top: 0; left: 0; width: 100%; height: 100%;
      ...
      font-family: 'Segoe UI', Arial, sans-serif;
    `,document.getElementById(`ui-overlay`).appendChild(this.container),this.container}showMain(){let e=this.createContainer();e.innerHTML=`
    ...
    `,e.querySelector(`#menu-start`).addEventListener(`touchstart`,e=>{e.preventDefault(),this.game.start()},{passive:!1}),e.querySelector(`#menu-start`).addEventListener(`click`,()=>{this.game.start()})}showPause(){let e=this.createContainer();e.innerHTML=`
      <div style="text-align: center;">
        <h2 style="
    ...
    `;let t=e.querySelector(`#menu-resume`);t.addEventListener(`touchstart`,e=>{e.preventDefault(),this.game.resume()},{passive:!1}),t.addEventListener(`click`,()=>this.game.resume());let n=e.querySelector(`#menu-restart`);n.addEventListener(`touchstart`,e=>{e.preventDefault(),this.game.restart()},{passive:!1}),n.addEventListener(`click`,()=>this.game.restart())}showGameOver(){let e=this.createContainer();e.style.background=`rgba(20,0,0,0.9)`,e.innerHTML=`
      <div style="text-align: center;">
        <div style="
    ...
    `;let t=e.querySelector(`#menu-retry`);t.addEventListener(`touchstart`,e=>{e.preventDefault(),this.game.restart()},{passive:!1}),t.addEventListener(`click`,()=>this.game.restart())}showVictory(e,t){let n=[`D`,`C`,`B`,`A`,`S`,`SS`,`SSS`],r=[`#666`,`#4488ff`,`#44ff44`,`#ffff44`,`#ff8844`,`#ff4444`,`#ff00ff`],i=this.createContainer();i.style.background=`rgba(0,0,10,0.9)`,i.innerHTML=`
      <div style="text-align: center;">
        <div style="
        ...
        <div style="margin: 20px 0;">
          <div style="font-size: 16px; color: #888; margin: 8px;">
            Red Orbs: <span style="color: #ff4444; font-size: 24px; font-weight: bold;">${e}</span>
          </div>
          <div style="font-size: 16px; color: #888; margin: 8px;">
            Best Style: <span style="
              color: ${r[t]};
              font-size: 36px; font-weight: bold; font-style: italic;
              text-shadow: 0 0 15px ${r[t]};
            ">${n[t]}</span>
          </div>
        </div>
    ...
    `;let a=i.querySelector(`#menu-replay`);a.addEventListener(`touchstart`,e=>{e.preventDefault(),this.game.restart()},{passive:!1}),a.addEventListener(`click`,()=>this.game.restart())}},el=class{constructor(e){this.game=e,this.particles=[],this.fireballs=[]}init(){}update(e){for(let t=this.particles.length-1;t>=0;t--){let n=this.particles[t];if(n.life-=e,n.life<=0){this.game.scene.remove(n.mesh),this.particles.splice(t,1);continue}let r=n.life/n.maxLife;if(n.mesh.position.x+=n.vx*e,n.mesh.position.y+=n.vy*e,n.mesh.position.z+=n.vz*e,n.gravity&&(n.vy-=10*e),n.mesh.material&&(n.mesh.material.opacity=r*n.startOpacity),n.shrink){let e=r*n.startScale;n.mesh.scale.setScalar(e)}n.rotSpeed&&(n.mesh.rotation.z+=n.rotSpeed*e)}for(let t=this.fireballs.length-1;t>=0;t--){let n=this.fireballs[t];if(n.life-=e,n.mesh.position.x+=n.dir.x*n.speed*e,n.mesh.position.y+=n.dir.y*n.speed*e,n.mesh.position.z+=n.dir.z*n.speed*e,n.mesh.rotation.x+=e*5,n.mesh.rotation.y+=e*3,Math.random()<.5&&this.spawnFireParticle(n.mesh.position.clone()),n.mesh.position.distanceTo(n.game.player.position.clone().add(new U(0,1,0)))<1.2){!n.game.player.invulnerable&&!n.game.player.isDodging()&&(n.game.player.takeDamage(15,n.dir.clone()),n.game.styleRank.onPlayerHit(),n.game.shake(.3,.15)),this.spawnHitSpark(n.mesh.position.clone()),this.game.scene.remove(n.mesh),this.fireballs.splice(t,1);continue}n.life<=0&&(this.game.scene.remove(n.mesh),this.fireballs.splice(t,1))}}clear(){for(let e of this.particles)this.game.scene.remove(e.mesh);this.particles=[];for(let e of this.fireballs)this.game.scene.remove(e.mesh);this.fireballs=[]}spawnParticle(e,t){let n=new Y(t.geo||new li(.1,4,4),new yr({color:t.color||16777215,transparent:!0,opacity:t.opacity||1,depthWrite:!1}));n.position.copy(e),t.scale&&n.scale.setScalar(t.scale),this.game.scene.add(n);let r={mesh:n,life:t.life||.5,maxLife:t.life||.5,vx:t.vx||0,vy:t.vy||0,vz:t.vz||0,gravity:t.gravity||!1,shrink:t.shrink!==!1,startOpacity:t.opacity||1,startScale:t.scale||1,rotSpeed:t.rotSpeed||0};return this.particles.push(r),r}spawnHitSpark(e){let t=[16746564,16763972,16729156,16777215];for(let n=0;n<8;n++){let n=Math.random()*Math.PI*2,r=2+Math.random()*4,i=1+Math.random()*3;this.spawnParticle(e.clone(),{color:t[Math.floor(Math.random()*t.length)],scale:.05+Math.random()*.08,life:.2+Math.random()*.3,vx:Math.cos(n)*r,vy:i,vz:Math.sin(n)*r,gravity:!0,opacity:1})}}spawnSlashTrail(e,t){let n=t?16720384:8947967;this.spawnParticle(e.clone(),{color:n,geo:new si(.3,.6),scale:1,life:.15,opacity:.6,rotSpeed:10,shrink:!0})}spawnMuzzleFlash(e){this.spawnParticle(e.clone(),{color:16777028,scale:.15,life:.06,opacity:1,shrink:!1});let t=new $i(16755200,3,3);t.position.copy(e),this.game.scene.add(t),setTimeout(()=>this.game.scene.remove(t),50)}spawnBulletTrail(e,t){let n=t.clone().sub(e),r=n.length(),i=e.clone().add(n.multiplyScalar(.5)),a=new Y(new ai(.01,.01,r,4),new yr({color:16777096,transparent:!0,opacity:.5}));a.position.copy(i),a.lookAt(t),a.rotateX(Math.PI/2),this.game.scene.add(a);let o={mesh:a,life:.08,maxLife:.08,vx:0,vy:0,vz:0,gravity:!1,shrink:!1,startOpacity:.5,startScale:1};this.particles.push(o)}spawnDeathBurst(e){for(let t=0;t<20;t++){let t=Math.random()*Math.PI*2,n=Math.random()*Math.PI,r=2+Math.random()*4;this.spawnParticle(e.clone(),{color:Math.random()<.5?8912964:4456482,scale:.1+Math.random()*.15,life:.5+Math.random()*.5,vx:Math.cos(t)*Math.sin(n)*r,vy:Math.cos(n)*r,vz:Math.sin(t)*Math.sin(n)*r,gravity:!0,opacity:.8})}for(let t=0;t<5;t++)this.spawnParticle(e.clone().add(new U((Math.random()-.5)*1,Math.random()*.5,(Math.random()-.5)*1)),{color:16711680,scale:.08,life:1+Math.random()*.5,vx:(Math.random()-.5)*.5,vy:2+Math.random()*2,vz:(Math.random()-.5)*.5,gravity:!1,opacity:.9})}spawnDTActivation(e){for(let t=0;t<30;t++){let t=Math.random()*Math.PI*2,n=3+Math.random()*6;this.spawnParticle(e.clone(),{color:Math.random()<.3?16711680:16729088,scale:.1+Math.random()*.2,life:.3+Math.random()*.5,vx:Math.cos(t)*n,vy:Math.random()*5,vz:Math.sin(t)*n,gravity:!1,opacity:.9,shrink:!0})}}spawnFireParticle(e){let t=[16729088,16746496,16763904,16720384];this.spawnParticle(e,{color:t[Math.floor(Math.random()*t.length)],scale:.06+Math.random()*.1,life:.3+Math.random()*.4,vx:(Math.random()-.5)*1,vy:1+Math.random()*2,vz:(Math.random()-.5)*1,gravity:!1,opacity:.7,shrink:!0})}spawnFireball(e,t,n){let r=new Y(new li(.4,6,6),new yr({color:16729088,transparent:!0,opacity:.9}));r.position.copy(e),this.game.scene.add(r);let i=new Y(new li(.25,6,6),new yr({color:16763904}));r.add(i);let a=new $i(16729088,3,5);r.add(a),this.fireballs.push({mesh:r,dir:t.clone(),speed:8,life:3,game:n})}spawnGroundSlam(e){for(let t=0;t<24;t++){let n=t/24*Math.PI*2,r=5+Math.random()*3;this.spawnParticle(e.clone().add(new U(0,.2,0)),{color:Math.random()<.5?8947814:6710852,scale:.15+Math.random()*.15,life:.4+Math.random()*.3,vx:Math.cos(n)*r,vy:1+Math.random()*2,vz:Math.sin(n)*r,gravity:!0,opacity:.6,shrink:!0})}for(let t=0;t<12;t++){let n=t/12*Math.PI*2;this.spawnParticle(e.clone().add(new U(Math.cos(n)*2,.1,Math.sin(n)*2)),{color:16729088,scale:.2,life:.5,vx:Math.cos(n)*2,vy:3,vz:Math.sin(n)*2,gravity:!1,opacity:.8,shrink:!0})}}},tl=class{constructor(e){this.game=e,this.ranks=[`D`,`C`,`B`,`A`,`S`,`SS`,`SSS`],this.rankColors=[`#666666`,`#4488ff`,`#44ff44`,`#ffff44`,`#ff8844`,`#ff4444`,`#ff00ff`],this.currentRank=0,this.bestRank=0,this.points=0,this.thresholds=[0,50,120,220,350,500,700],this.decayRate=15,this.decayDelay=2,this.timeSinceLastHit=0,this.comboCount=0,this.lastAttackType=``,this.varietyBonus=1,this.attackTypes=new Set}reset(){this.currentRank=0,this.bestRank=0,this.points=0,this.comboCount=0,this.timeSinceLastHit=0,this.attackTypes.clear(),this.varietyBonus=1}onHit(e){this.timeSinceLastHit=0,this.comboCount++,e!==this.lastAttackType&&(this.varietyBonus=Math.min(3,this.varietyBonus+.3)),this.lastAttackType=e,this.attackTypes.add(e);let t;switch(e){case`sword1`:t=10;break;case`sword2`:t=15;break;case`sword3`:t=25;break;case`stinger`:t=30;break;case`highTime`:t=20;break;case`aerial`:t=18;break;case`gun`:t=5;break;default:t=8}this.points+=t*this.varietyBonus;let n=this.currentRank;for(let e=this.ranks.length-1;e>=0;e--)if(this.points>=this.thresholds[e]){this.currentRank=e;break}this.currentRank>n&&(this.game.audio.playSFX(`styleUp`),this.game.hud.flashStyle()),this.currentRank>this.bestRank&&(this.bestRank=this.currentRank),this.game.player.dtGauge=Math.min(this.game.player.maxDT,this.game.player.dtGauge+t*.3)}onPlayerHit(){this.points=Math.max(0,this.points-100),this.comboCount=0,this.varietyBonus=1,this.attackTypes.clear(),this.currentRank=0;for(let e=this.ranks.length-1;e>=0;e--)if(this.points>=this.thresholds[e]){this.currentRank=e;break}}update(e){if(this.timeSinceLastHit+=e,this.timeSinceLastHit>this.decayDelay){this.points=Math.max(0,this.points-this.decayRate*e),this.varietyBonus=Math.max(1,this.varietyBonus-e*.5),this.currentRank=0;for(let e=this.ranks.length-1;e>=0;e--)if(this.points>=this.thresholds[e]){this.currentRank=e;break}}this.timeSinceLastHit>3&&(this.comboCount=0,this.attackTypes.clear())}getRankText(){return this.ranks[this.currentRank]}getRankColor(){return this.rankColors[this.currentRank]}getComboCount(){return this.comboCount}},nl=class{constructor(){this.canvas=document.getElementById(`game-canvas`),this.overlay=document.getElementById(`ui-overlay`),this.renderer=new zc({canvas:this.canvas,antialias:!0,alpha:!1,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.shadowMap.enabled=!1,this.renderer.toneMapping=0,this.renderer.outputColorSpace=Le,this.scene=new hn,this.scene.background=new q(2236979),this.scene.fog=new mn(2236979,.008),this.clock=new ba,this.accumulator=0,this.fixedDt=1/60,this.state=`menu`,this.redOrbs=0,this.currentRoom=0,this.totalRooms=5,this.screenShake=0,this.screenShakeIntensity=0,this.camera=new Bc(this),this.input=new Vc(this),this.audio=new Hc(this),this.particles=new el(this),this.styleRank=new tl(this),this.level=new Xc(this),this.player=new Wc(this),this.enemyManager=new Yc(this),this.touchControls=new Qc(this),this.hud=new Zc(this),this.menu=new $c(this),window.addEventListener(`resize`,()=>this.onResize()),this.onResize(),window.addEventListener(`contextmenu`,e=>e.preventDefault()),screen.orientation&&screen.orientation.lock&&screen.orientation.lock(`landscape`).catch(()=>{})}init(){this.level.buildRoom(0),this.player.init(),this.camera.init(),this.particles.init(),this.hud.init(),this.touchControls.init(),this.menu.show(),this.audio.init()}start(){this.state=`playing`,this.menu.hide(),this.enemyManager.spawnWave(this.currentRoom),this.audio.playBGM(),this.hud.show(),this.touchControls.show()}pause(){this.state===`playing`&&(this.state=`paused`,this.menu.showPause(),this.audio.pauseBGM())}resume(){this.state===`paused`&&(this.state=`playing`,this.menu.hide(),this.audio.playBGM())}gameOver(){this.state=`gameover`,this.audio.stopBGM(),this.audio.playSFX(`gameOver`),this.menu.showGameOver(),this.touchControls.hide()}victory(){this.state=`victory`,this.audio.stopBGM(),this.audio.playSFX(`victory`),this.menu.showVictory(this.redOrbs,this.styleRank.bestRank),this.touchControls.hide()}restart(){this.redOrbs=0,this.currentRoom=0,this.screenShake=0,this.styleRank.reset(),this.enemyManager.clearAll(),this.particles.clear(),this.level.buildRoom(0),this.player.reset(),this.camera.reset(),this.start()}nextRoom(){if(this.currentRoom++,this.currentRoom>=this.totalRooms){this.victory();return}this.enemyManager.clearAll(),this.particles.clear(),this.level.buildRoom(this.currentRoom),this.player.enterRoom(),this.camera.reset(),this.enemyManager.spawnWave(this.currentRoom)}addRedOrbs(e){this.redOrbs+=e,this.hud.flashOrbs()}shake(e,t){this.screenShake=t,this.screenShakeIntensity=e}onResize(){let e=window.innerWidth,t=window.innerHeight;this.renderer.setSize(e,t),this.camera.onResize(e,t)}update(){let e=Math.min(this.clock.getDelta(),.1);if(this.state===`playing`){for(this.accumulator+=e;this.accumulator>=this.fixedDt;)this.fixedUpdate(this.fixedDt),this.accumulator-=this.fixedDt;this.lateUpdate(e)}this.render(),requestAnimationFrame(()=>this.update())}fixedUpdate(e){this.input.update(e),this.player.update(e),this.enemyManager.update(e),this.styleRank.update(e),this.particles.update(e),this.checkCollisions(),this.checkRoomClear()}lateUpdate(e){if(this.camera.update(e),this.hud.update(e),this.screenShake>0){this.screenShake-=e;let t=this.screenShakeIntensity*(this.screenShake>0?1:0);this.camera.applyShake(t)}}checkCollisions(){let e=this.player.position;if(this.player.isAttacking()){let t=this.player.getAttackRange(),n=this.player.getAttackDirection(),r=this.player.getAttackDamage();for(let i of this.enemyManager.enemies){if(i.dead||i.invulnerable)continue;let a=e.distanceTo(i.position);if(a<t+i.radius){let t=i.position.clone().sub(e).normalize();(n.dot(t)>-.3||a<1.5)&&(this.player.currentHitEnemies.has(i.id)||(this.player.currentHitEnemies.add(i.id),i.takeDamage(r,n,this.player.currentAttackType),this.styleRank.onHit(this.player.currentAttackType),this.addRedOrbs(Math.floor(r*2)),this.shake(.15,.1),this.particles.spawnHitSpark(i.position.clone().add(new U(0,1,0)))))}}}for(let t of this.enemyManager.enemies)t.dead||!t.isAttacking()||e.distanceTo(t.position)<t.attackRange+.5&&!this.player.invulnerable&&!this.player.isDodging()&&(this.player.takeDamage(t.attackDamage,t.getAttackDirection()),this.styleRank.onPlayerHit(),this.shake(.3,.15));let t=this.level.getBounds();e.x=Math.max(t.minX+.5,Math.min(t.maxX-.5,e.x)),e.z=Math.max(t.minZ+.5,Math.min(t.maxZ-.5,e.z))}checkRoomClear(){this.enemyManager.allDead()&&this.enemyManager.waveSpawned&&(this.enemyManager.waveSpawned=!1,setTimeout(()=>{this.state===`playing`&&this.level.openDoor()},1500))}render(){this.renderer.render(this.scene,this.camera.camera)}},rl;function il(){let e=document.getElementById(`loading-bar`),t=document.getElementById(`loading-screen`),n=0,r=setInterval(()=>{n+=5+Math.random()*15,n>=100&&(n=100,clearInterval(r),rl=new nl,rl.init(),t.style.opacity=`0`,setTimeout(()=>{t.style.display=`none`},500),rl.update()),e.style.width=`${Math.min(100,n)}%`},100)}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,il):il(),document.addEventListener(`visibilitychange`,()=>{rl&&document.hidden&&rl.state===`playing`&&rl.pause()}),document.body.addEventListener(`touchmove`,e=>{e.touches.length===1&&e.preventDefault()},{passive:!1});